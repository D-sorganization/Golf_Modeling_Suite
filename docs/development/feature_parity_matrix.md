...
| `simulation.swing_objective_lab`<br>Swing Objective Lab — mechanism-vs-outcome downswing comparison | 🔴 gap | `src/launchers/adapters/swing_objective_lab_embed.py` | — | — | #9128 |

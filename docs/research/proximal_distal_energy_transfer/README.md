...
(thesis expansion + modeling pathway). Published live on [affinedrift.com](https://affinedrift.com/articles/proximal-distal-energy-transfer.html) (AffineDrift epic [#3782](https://github.com/D-sorganization/AffineDrift/issues/3782)).

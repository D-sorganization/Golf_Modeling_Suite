...
| `momentum_transfer_readiness_audit.json`     | Nine-point source-agenda coverage, answer state, next test, falsifier, linked experiment, and human-data gate                                                                    | Planning and evidence-readiness authority; not new evidence                            |

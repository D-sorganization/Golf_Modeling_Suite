...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, opacityback=0, left=2mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, colback=white, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Plain-language picture}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, opacityback=0, left=2mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, colback=white, arc=.35mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm]

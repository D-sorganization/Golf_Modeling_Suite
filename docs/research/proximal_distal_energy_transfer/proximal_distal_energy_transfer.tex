...
\begin{tcolorbox}[enhanced jigsaw, breakable, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, toptitle=1mm, leftrule=.75mm, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, colframe=quarto-callout-note-color-frame, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacityback=0, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Plain-language picture}, toptitle=1mm, leftrule=.75mm, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, colframe=quarto-callout-note-color-frame, arc=.35mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacityback=0, left=2mm]

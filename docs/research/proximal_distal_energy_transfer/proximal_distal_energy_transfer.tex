...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, toptitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, arc=.35mm, coltitle=black, opacityback=0, left=2mm, breakable, titlerule=0mm, bottomtitle=1mm, bottomrule=.15mm]
...
force-history discrepancies are \(1.53\times10^{-14}\) and
\(1.34\times10^{-11}\) relative, respectively.

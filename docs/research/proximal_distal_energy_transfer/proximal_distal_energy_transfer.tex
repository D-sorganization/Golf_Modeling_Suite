...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, leftrule=.75mm, left=2mm, coltitle=black, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomrule=.15mm, titlerule=0mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, rightrule=.15mm, breakable, arc=.35mm, colback=white, colframe=quarto-callout-note-color-frame, opacityback=0]

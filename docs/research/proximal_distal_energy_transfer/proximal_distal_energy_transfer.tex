...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Provenance and scope}, left=2mm, toptitle=1mm, breakable, opacityback=0, coltitle=black, colframe=quarto-callout-note-color-frame, titlerule=0mm, colback=white, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6]
...
pattern of Section~\ref{sec-hypothesis} in full; and (vi) the entire
ordering survives linear torque-velocity bounds on the drives, with
compressed effect sizes and slightly earlier optima
(Section~\ref{sec-results-e1b}).
...
\item
  \texttt{data/e1b\_bounded\_sweep.json} --- the bounded-actuator sweep
  rows with their own provenance block (isometric torques,
  \(\omega_{\max}\) values).
\end{itemize}

...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, titlerule=0mm, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, toptitle=1mm, colback=white, bottomtitle=1mm, arc=.35mm, colframe=quarto-callout-note-color-frame, opacityback=0, toprule=.15mm, leftrule=.75mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, titlerule=0mm, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Plain-language picture}, toptitle=1mm, colback=white, bottomtitle=1mm, arc=.35mm, colframe=quarto-callout-note-color-frame, opacityback=0, toprule=.15mm, leftrule=.75mm, rightrule=.15mm]

...
% Share included-figure font resources instead of copying each font.
\pdfvariable inclusioncopyfonts=0
\makeatletter
...
transport, ground reaction force, contact dynamics, force plate},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
falsification protocol. References, analysis code, machine-readable
results, and provenance are available with the document for independent
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, arc=.35mm, left=2mm, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, breakable, leftrule=.75mm, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, bottomtitle=1mm, toprule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, coltitle=black]

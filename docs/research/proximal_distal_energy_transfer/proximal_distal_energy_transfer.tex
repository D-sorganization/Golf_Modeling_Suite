...
full-body cross-engine dynamics unexecuted. References, analysis code,
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, toprule=.15mm, coltitle=black, colframe=quarto-callout-note-color-frame, left=2mm, breakable, opacitybacktitle=0.6, arc=.35mm, toptitle=1mm, rightrule=.15mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, bottomtitle=1mm, leftrule=.75mm, bottomrule=.15mm, colback=white]

...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, leftrule=.75mm, arc=.35mm, colback=white, left=2mm, titlerule=0mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, breakable, opacityback=0, bottomrule=.15mm, bottomtitle=1mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, toptitle=1mm, rightrule=.15mm]

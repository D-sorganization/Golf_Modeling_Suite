...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-note-color-frame, left=2mm, bottomtitle=1mm, breakable, leftrule=.75mm, bottomrule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, toprule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, arc=.35mm, opacityback=0, coltitle=black]

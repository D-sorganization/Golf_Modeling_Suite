...
A separate hand-path attribution study evaluates the MacKenzie
force-work-per-path-length estimand in an impact-truncated double
pendulum, a forward-simulated one-arm model, and a mechanically closed
two-arm local sweep. Drift supplies 101.2\% and 103.5\% of signed
hand-path force work in the two forward cases because the
contemporaneous control contribution is slightly opposing; in the
...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, left=2mm, bottomtitle=1mm, titlerule=0mm, opacityback=0, leftrule=.75mm, colback=white, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, arc=.35mm, toprule=.15mm]

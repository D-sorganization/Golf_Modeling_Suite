...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, arc=.35mm, leftrule=.75mm, titlerule=0mm, coltitle=black, colback=white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, opacitybacktitle=0.6, opacityback=0, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, toptitle=1mm, bottomrule=.15mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white]

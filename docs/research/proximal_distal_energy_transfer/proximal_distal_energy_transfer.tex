...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, breakable, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, left=2mm, coltitle=black, rightrule=.15mm, toprule=.15mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, arc=.35mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, breakable, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, left=2mm, coltitle=black, rightrule=.15mm, toprule=.15mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Plain-language picture}, arc=.35mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, titlerule=0mm]

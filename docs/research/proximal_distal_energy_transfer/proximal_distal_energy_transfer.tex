...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacitybacktitle=0.6, left=2mm, opacityback=0, arc=.35mm, bottomtitle=1mm, breakable, rightrule=.15mm, titlerule=0mm, leftrule=.75mm, toptitle=1mm, colback=white, coltitle=black, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}]
...
Unresolved for people. State triggering improves selected synthetic
outcomes but assumes state access and does not prove reduced neural
timing demand. & Clock, state, impedance, and delayed-observer policies
compared by viable timing-region volume, lower-tail outcome, phase
error, delay, saturation, force, and effort. \\
Is a strategy self-correcting? & Not established. Low perturbation
sensitivity is not self-correction without a recovery mechanism. &
Matched perturbations demonstrating error decay, recovery time,
viable-set return probability, attraction-region size, and no hidden
load-cost increase. \\

...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, arc=.35mm, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, titlerule=0mm, toptitle=1mm, bottomtitle=1mm, bottomrule=.15mm, toprule=.15mm, left=2mm, opacityback=0, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, colback=white, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
...
moment-arm reversals. & Subject-scaled scapular/arm/grip geometry,
calibrated contact compliance, and equipment geometry evaluated with
held-out digital twins and human bilateral wrenches. \\
...
contacts are feasible and used by people.

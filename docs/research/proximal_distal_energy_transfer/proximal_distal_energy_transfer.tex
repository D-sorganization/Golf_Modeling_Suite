...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, bottomtitle=1mm, coltitle=black, titlerule=0mm, colframe=quarto-callout-note-color-frame, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, arc=.35mm, bottomrule=.15mm, colback=white, rightrule=.15mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Plain-language picture}, bottomtitle=1mm, coltitle=black, titlerule=0mm, colframe=quarto-callout-note-color-frame, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, arc=.35mm, bottomrule=.15mm, colback=white, rightrule=.15mm, toprule=.15mm]

...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, left=2mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, colback=white, opacityback=0, coltitle=black, toptitle=1mm, titlerule=0mm, arc=.35mm, rightrule=.15mm, opacitybacktitle=0.6]

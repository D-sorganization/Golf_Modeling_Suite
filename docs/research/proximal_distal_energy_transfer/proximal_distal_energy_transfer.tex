...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, colback=white, titlerule=0mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toprule=.15mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, bottomtitle=1mm, breakable, toptitle=1mm, left=2mm, rightrule=.15mm, arc=.35mm, coltitle=black]
...
\tightlist
\item
  One representative pointwise and matched-state torque-killswitch
  comparison is complete; a multi-phase, multi-program ensemble with
  uncertainty analysis remains necessary before making general
  persistence claims.
\item

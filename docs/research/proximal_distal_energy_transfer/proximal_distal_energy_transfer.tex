...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomtitle=1mm, bottomrule=.15mm, titlerule=0mm, toptitle=1mm, rightrule=.15mm, breakable, colback=white, coltitle=black, colframe=quarto-callout-note-color-frame, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, left=2mm, opacitybacktitle=0.6, opacityback=0]

...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, bottomtitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, rightrule=.15mm, breakable, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, titlerule=0mm, arc=.35mm, coltitle=black, colback=white, left=2mm, colbacktitle=quarto-callout-note-color!10!white]
...
dynamics for 5 ms. The bilateral and typed unilateral tiers repeat
power, work--energy, refinement, adverse-load, and engine-parity
controls. The unilateral tier distinguishes open, taut, opening, and
reattachment states, but it still lacks calibrated tissue, friction,
distributed grip and shaft compliance, and ground coupling. The next
experiment must extend those typed states and repeat the geometry,
reversal, and killswitch controls. Only trajectories passing those gates
may be used to test whether drift-mediated transfer reduces timing

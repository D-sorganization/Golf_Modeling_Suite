...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomtitle=1mm, titlerule=0mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, toprule=.15mm, arc=.35mm, opacityback=0, rightrule=.15mm, colback=white, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomtitle=1mm, titlerule=0mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Plain-language picture}, toprule=.15mm, arc=.35mm, opacityback=0, rightrule=.15mm, colback=white, colbacktitle=quarto-callout-note-color!10!white]
...
source and execution-module digests, package and engine versions, thread
settings, and numerical-kernel dispatch are qualified before execution.
The actual campaign runner must reproduce that audit exactly before any
case is evaluated. The OpenBLAS kernel path is pinned with

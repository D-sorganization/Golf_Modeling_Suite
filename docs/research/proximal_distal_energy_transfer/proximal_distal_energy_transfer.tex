...
are prescribed, passive spatial contact remains inconclusive and forward
cross-engine contact remains untested. A coupled uncertainty and control
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, arc=.35mm, titlerule=0mm, opacityback=0, coltitle=black, colframe=quarto-callout-note-color-frame, colback=white, breakable, bottomtitle=1mm, leftrule=.75mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, rightrule=.15mm, bottomrule=.15mm]
...
rather than as evidence for a software platform. Seven presets identify
...
spatial common state, uncertainty/control, and experimental readiness.
...
case. It records forward passive spatial contact and human predictions
...
forward spatial contact in two engines; an equipment-calibrated
distributed beam coupled into the forward two-hand solve; governed
held-out human evaluation; and external archive deposit with a

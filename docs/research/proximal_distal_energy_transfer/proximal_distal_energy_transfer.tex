...
are nonmonotonic. This remains a planar mechanism result. A frozen
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, titlerule=0mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, arc=.35mm, breakable, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, coltitle=black, opacityback=0, bottomtitle=1mm, rightrule=.15mm, toptitle=1mm, leftrule=.75mm, colback=white]
...
subquestion. Five presently have a model-bounded answer or a negative
general-rule result. Four remain unresolved or definition-gated. All
nine have a registered model experiment and a participant-held-out human
stage, but the latter remains blocked by the bilateral-wrench data
boundary.
...
Geometry dependencies & Partly answered through reduced spatial controls
& Subject-scaled articulated geometry and calibrated contact \\
Casting & Unresolved as a single construct & Multiple preregistered
event definitions under matched controls \\
...
Timing precision & Unresolved & Matched viable-volume and phase-error
comparison \\
Self-correction and noise robustness & Unresolved & Attraction-region
and adverse-load recovery study \\
...
Slack & Unresolved until typed & One-class-at-a-time passivity,
hysteresis, and identifiability suite \\
\end{longtable}

...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, titlerule=0mm, opacityback=0, breakable, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, colbacktitle=quarto-callout-note-color!10!white, colback=white, arc=.35mm, opacitybacktitle=0.6, left=2mm]

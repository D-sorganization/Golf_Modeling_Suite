...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, coltitle=black, bottomtitle=1mm, rightrule=.15mm, breakable, leftrule=.75mm, titlerule=0mm, colback=white, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, toptitle=1mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0]

...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, bottomtitle=1mm, arc=.35mm, opacitybacktitle=0.6, coltitle=black, colback=white, colframe=quarto-callout-note-color-frame, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, breakable, titlerule=0mm, opacityback=0, toprule=.15mm, leftrule=.75mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white]

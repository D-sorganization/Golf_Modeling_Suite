...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, coltitle=black, opacityback=0, colframe=quarto-callout-note-color-frame, colback=white, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, breakable, rightrule=.15mm, leftrule=.75mm, toprule=.15mm]

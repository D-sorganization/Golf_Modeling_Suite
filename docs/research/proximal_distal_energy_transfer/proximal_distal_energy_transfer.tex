...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomrule=.15mm, colback=white, breakable, opacitybacktitle=0.6, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, coltitle=black, bottomtitle=1mm, arc=.35mm, titlerule=0mm, rightrule=.15mm, opacityback=0]
...
strengthens the reduced cross-engine reference that the articulated tier
must reproduce; it does not establish anatomy, passive human transfer,
timing economy, slack benefit, or coaching strategy.
...
The next spatial experiment must retain the verified closed-state
initialization while replacing the hand carriages with articulated
forward dynamics, expose contact loss and tissue/shaft compliance as
typed states, and repeat the coincident, reversal, killswitch, power,
and work--energy controls in two independent engines. Only trajectories

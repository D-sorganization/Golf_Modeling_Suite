...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, rightrule=.15mm, titlerule=0mm, coltitle=black, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, left=2mm, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and evidence categories}, toprule=.15mm, colback=white]

...
\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, left=2mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, breakable, bottomrule=.15mm, bottomtitle=1mm, opacityback=0, titlerule=0mm, toptitle=1mm, rightrule=.15mm, arc=.35mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Plain-language picture}, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, left=2mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, breakable, bottomrule=.15mm, bottomtitle=1mm, opacityback=0, titlerule=0mm, toptitle=1mm, rightrule=.15mm, arc=.35mm, opacitybacktitle=0.6]

...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, rightrule=.15mm, colback=white, left=2mm, breakable, toptitle=1mm, arc=.35mm, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, bottomrule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, coltitle=black]
...
controls. It still lacks calibrated tissue, pressure, friction, shaft
compliance, and ground coupling. The next tests must add shaft and
ground pathways separately before combining them and repeating
matched-state, work, load, reversal, and killswitch controls. Only
trajectories passing those gates may test whether drift-mediated
transfer reduces timing demand, creates recovery, benefits from slack,
or supports a human strategy.
...
\item
  every articulated forward branch still uses a rigid club and unchanged
  support pathway rather than the distributed shaft and
  ground/free-moment system.
\end{itemize}

The next decisive model tests add shaft bending/torsion and a finite
ground/free-moment pathway separately before combining them with the
distributed articulated grip. Each must emit the same common schema and
retain the exact same-state command-removal branch. Failure of
force/moment balance, power invariance, contact-rank agreement,
refinement, or matched-event parity at those tiers would falsify
transport of the reduced passive-persistence claim.
...
registered reduced-tree configurations. The resulting hand-carriage
reference retains all registered cross-engine and energy gates through
50 ms under nine one-factor adverse or null branches. & Replace the
carriages with articulated subject-scaled arms, calibrated distributed
grip and shaft properties, contact loss, and ground coupling; then
repeat the horizon, geometry, killswitch, and held-out human
bilateral-wrench tests. \\

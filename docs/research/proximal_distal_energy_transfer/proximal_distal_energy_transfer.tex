...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, leftrule=.75mm, breakable, opacitybacktitle=0.6, opacityback=0, left=2mm, toprule=.15mm, titlerule=0mm, colback=white, coltitle=black, bottomrule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, arc=.35mm]

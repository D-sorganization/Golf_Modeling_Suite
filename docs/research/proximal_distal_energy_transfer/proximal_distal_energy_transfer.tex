...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, breakable, coltitle=black, bottomtitle=1mm, colback=white, opacitybacktitle=0.6, toptitle=1mm, colframe=quarto-callout-note-color-frame, left=2mm, opacityback=0, titlerule=0mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm, arc=.35mm]
...
closure, declared-domain status, and cross-engine parity.
...
Across 384 pathway and 192 independent-control trajectories, both native
engines agree, energy residuals decrease with step refinement, and all
declared shaft/base domains hold through 50 ms. Ground force and
intrinsic free moment are mechanically active, but none of 384
coupled--fixed comparisons meets the preregistered 5\% peak-load and

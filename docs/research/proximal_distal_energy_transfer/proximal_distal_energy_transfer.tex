...
though every local contact Jacobian has rank six. A subsequent reduced
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacityback=0, colframe=quarto-callout-note-color-frame, coltitle=black, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, toptitle=1mm, bottomtitle=1mm, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, titlerule=0mm, left=2mm, colback=white, opacitybacktitle=0.6]
...
This result narrows the next spatial experiment. A subject-scaled model
must first solve bilateral closed-contact inverse kinematics with
joint-limit and collision checks. It must then integrate calibrated
compliant contact from the same closed initial state, expose contact
loss or tissue/shaft compliance as typed states, and repeat the
coincident, reversal, killswitch, power, and work--energy controls in
two independent engines. Only trajectories passing those gates may be
used to test whether drift-mediated transfer reduces timing demand,
...
\item
  ...
  mechanics. The subject-scaled audit further shows that its prescribed
  states do not close the anatomical hands on the declared grip points.
\item
...
moment-arm reversals. A six-profile subject-scaled audit finds that the
prescribed spatial states miss bilateral grip closure by 0.171--0.616 m
despite a full-rank local constraint Jacobian. & Closed-contact inverse
kinematics with joint-limit and collision checks, calibrated contact
compliance, equipment geometry, and held-out digital twins and human
bilateral wrenches. \\
...
delivery. Any such proposal must still survive matched-energy,
zero-slack, direction-reversal, passivity, work-energy closure, and
independent-measurement controls in a forward delivery model.
...
general-rule result. One remains unresolved as a single construct. All
...
Timing precision & Partly answered; a state-trigger volume advantage is
not supported in the registered planar tier & Continuous common-phase
spatial and subject-scaled comparison \\
...
\item
  ...
  arms and calibrated grip interfaces. First require bilateral
  closed-contact inverse kinematics, joint-limit and collision
  qualification, then preserve the two-engine same-state killswitch,

...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, toptitle=1mm, colback=white, coltitle=black, breakable, arc=.35mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, bottomrule=.15mm, left=2mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, leftrule=.75mm, opacityback=0]

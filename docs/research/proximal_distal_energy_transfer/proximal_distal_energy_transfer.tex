...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, breakable, rightrule=.15mm, colback=white, toptitle=1mm, opacitybacktitle=0.6, bottomrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, toprule=.15mm, arc=.35mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, coltitle=black]

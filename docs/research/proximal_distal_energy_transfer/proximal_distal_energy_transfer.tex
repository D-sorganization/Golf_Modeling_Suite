...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, leftrule=.75mm, colback=white, arc=.35mm, opacitybacktitle=0.6, left=2mm, opacityback=0, coltitle=black, titlerule=0mm, breakable, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white]

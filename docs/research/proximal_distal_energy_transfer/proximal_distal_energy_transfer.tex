...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, arc=.35mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6, rightrule=.15mm]
...
contains every earlier mechanism. Nine bounded findings are supported

...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, toptitle=1mm, colback=white, titlerule=0mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, leftrule=.75mm, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, toprule=.15mm, opacityback=0]

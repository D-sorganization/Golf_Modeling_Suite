...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, opacityback=0, toprule=.15mm, arc=.35mm, left=2mm, coltitle=black, colback=white, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, rightrule=.15mm, leftrule=.75mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm]

...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, bottomrule=.15mm, leftrule=.75mm, breakable, arc=.35mm, coltitle=black, left=2mm, opacitybacktitle=0.6, opacityback=0, toptitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, rightrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, toprule=.15mm]

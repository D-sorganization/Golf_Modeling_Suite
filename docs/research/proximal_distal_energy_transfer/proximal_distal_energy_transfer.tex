...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, opacitybacktitle=0.6, toptitle=1mm, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, opacityback=0, leftrule=.75mm, toprule=.15mm, breakable, colback=white]

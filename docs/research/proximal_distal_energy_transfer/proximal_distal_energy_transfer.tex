...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, colback=white, colframe=quarto-callout-note-color-frame, toprule=.15mm, opacityback=0, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, arc=.35mm, leftrule=.75mm, titlerule=0mm, opacitybacktitle=0.6, breakable, bottomrule=.15mm, bottomtitle=1mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, left=2mm, colback=white, colframe=quarto-callout-note-color-frame, toprule=.15mm, opacityback=0, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Plain-language picture}, arc=.35mm, leftrule=.75mm, titlerule=0mm, opacitybacktitle=0.6, breakable, bottomrule=.15mm, bottomtitle=1mm]
...
\(6.88\times10^{-6}\), while three complete symmetric perturbation
rollouts agree with the propagated map within \(3.46\times10^{-7}\). At
the 0.349256 s geometric delivery event, the largest observed scaled
gain is 8.33244 and the smallest is 0.093456. Thus the local map
amplifies some perturbation directions while contracting others; a
single label such as ``stable swing'' would discard that anisotropy.
...
The current census contains 315 material claims. The normalized outcome
...
\texttt{project\_derivation\_or\_document} & 100 \\
\texttt{project\_executable\_or\_generated} & 286 \\
...
ch07 model ladder & 21 & 21 / 0 / 0 & project authored only \\

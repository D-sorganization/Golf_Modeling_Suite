...
\begin{tcolorbox}[enhanced jigsaw, colback=white, rightrule=.15mm, left=2mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, toprule=.15mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, opacitybacktitle=0.6, arc=.35mm, breakable, titlerule=0mm, coltitle=black, leftrule=.75mm]

...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, colback=white, arc=.35mm, rightrule=.15mm, toprule=.15mm, toptitle=1mm, titlerule=0mm, bottomtitle=1mm, opacityback=0, breakable, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame]
...
subquestion. Seven presently have a model-bounded answer or a negative
general-rule result. Two remain unresolved or definition-gated. All nine
have a registered model experiment and a participant-held-out human

...
relative-orientation geometry. References, analysis code,
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colback=white, breakable, colframe=quarto-callout-note-color-frame, left=2mm, opacityback=0, coltitle=black, toprule=.15mm, toptitle=1mm, leftrule=.75mm, bottomtitle=1mm, rightrule=.15mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white]

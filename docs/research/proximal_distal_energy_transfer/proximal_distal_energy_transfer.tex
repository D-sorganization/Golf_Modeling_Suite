...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, left=2mm, arc=.35mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, leftrule=.75mm, titlerule=0mm, breakable, opacityback=0, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, bottomtitle=1mm, rightrule=.15mm, coltitle=black]
...
and control components leave a small net resultant. The dashed ZVCF
...
signal- tracking result: anticipation can compensate a declared

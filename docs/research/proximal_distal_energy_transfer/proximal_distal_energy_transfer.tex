...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, colframe=quarto-callout-note-color-frame, toprule=.15mm, opacityback=0, breakable, colback=white, rightrule=.15mm, opacitybacktitle=0.6, bottomtitle=1mm, toptitle=1mm, titlerule=0mm, bottomrule=.15mm, arc=.35mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white]

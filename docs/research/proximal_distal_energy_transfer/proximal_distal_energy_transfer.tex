...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, left=2mm, toprule=.15mm, toptitle=1mm, arc=.35mm, breakable, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, leftrule=.75mm, coltitle=black, opacityback=0, colback=white, colbacktitle=quarto-callout-note-color!10!white]

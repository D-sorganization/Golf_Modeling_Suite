...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, arc=.35mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, bottomtitle=1mm, breakable, left=2mm, toptitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, rightrule=.15mm, bottomrule=.15mm, opacityback=0, titlerule=0mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, arc=.35mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Plain-language picture}, bottomtitle=1mm, breakable, left=2mm, toptitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, rightrule=.15mm, bottomrule=.15mm, opacityback=0, titlerule=0mm, toprule=.15mm]

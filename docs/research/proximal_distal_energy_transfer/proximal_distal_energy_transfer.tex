...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacitybacktitle=0.6, arc=.35mm, opacityback=0, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toprule=.15mm, breakable, titlerule=0mm, coltitle=black, bottomrule=.15mm, leftrule=.75mm, rightrule=.15mm]
...
initialization while replacing the hand carriages with articulated
forward dynamics for 5 ms. It repeats power, work--energy, refinement,
adverse-load, and engine-parity controls, but its bilateral springs do
not expose unilateral contact loss or tissue/shaft compliance. The next
experiment must add those typed states, extend the horizon, and repeat
the coincident, reversal, and killswitch controls. Only trajectories
passing those gates may be used to test whether drift-mediated transfer
reduces timing demand, creates recovery, benefits from slack, or
...
\item
  ...
  attachment separation, power, and energy in two engines. They do not
  test unilateral contact loss, calibrated distributed grip or shaft
  mechanics, late downswing, or impact.
\item
...
articulated tier adds a right-censored 5 ms bilateral-attachment result;
calibrated articulated and human transport remain untested.

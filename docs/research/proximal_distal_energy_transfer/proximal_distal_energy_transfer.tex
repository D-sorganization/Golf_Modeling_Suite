...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, breakable, arc=.35mm, colback=white, titlerule=0mm, left=2mm, opacityback=0, rightrule=.15mm, bottomtitle=1mm, coltitle=black, toprule=.15mm]

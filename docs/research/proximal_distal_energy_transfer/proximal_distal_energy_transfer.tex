...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, left=2mm, titlerule=0mm, opacityback=0, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, toptitle=1mm, colframe=quarto-callout-note-color-frame, breakable, bottomtitle=1mm, arc=.35mm, leftrule=.75mm, rightrule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, colback=white, toprule=.15mm]

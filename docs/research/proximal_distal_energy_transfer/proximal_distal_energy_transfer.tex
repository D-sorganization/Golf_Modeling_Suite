...
dynamics, cross-engine pose interchange},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
but do not identify anatomy or a preferred technique. References,
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colback=white, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, left=2mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacityback=0, titlerule=0mm, rightrule=.15mm, coltitle=black, opacitybacktitle=0.6]

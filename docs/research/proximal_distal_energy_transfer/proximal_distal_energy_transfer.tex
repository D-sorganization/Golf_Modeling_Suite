...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, coltitle=black, leftrule=.75mm, toprule=.15mm, bottomtitle=1mm, titlerule=0mm, colback=white, colframe=quarto-callout-note-color-frame, arc=.35mm, breakable, opacitybacktitle=0.6, opacityback=0]
...
the affine control system, containing gravity plus all motion-dependent
interaction dynamics. The ZVCF (Equation~\ref{eq-zvcf}) answers
\emph{``what would the currently applied torques, together with gravity,
...
affine in \(\tau\) at a fixed state and unchanged constraint set, the
actual acceleration superposes exactly:

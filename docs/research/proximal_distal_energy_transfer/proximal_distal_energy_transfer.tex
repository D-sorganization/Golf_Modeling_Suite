...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, arc=.35mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacitybacktitle=0.6, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, breakable, rightrule=.15mm, titlerule=0mm, coltitle=black, toprule=.15mm, opacityback=0, leftrule=.75mm]

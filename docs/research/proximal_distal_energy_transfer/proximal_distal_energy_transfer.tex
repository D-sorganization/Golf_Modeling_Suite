...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, bottomtitle=1mm, left=2mm, coltitle=black, leftrule=.75mm, rightrule=.15mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, colframe=quarto-callout-note-color-frame, toptitle=1mm, breakable, titlerule=0mm, arc=.35mm, opacitybacktitle=0.6, opacityback=0, colbacktitle=quarto-callout-note-color!10!white]
...
largest virtual-power residual is \(1.22\times10^{-15}\) W and positive
damping power is zero. The worst normalized work--energy residual
decreases from 0.03346 to 0.01673 when the step is halved. Trajectory
and station-force discrepancies between engines are zero at the stored
precision, with no nominal or event active-set parity failure. At the
...
velocity to at most \(9.65\times10^{-11}\) m/s. MuJoCo and Pinocchio
return identical projected velocities at stored precision and identical
active sets. The instantaneous captured kinetic energy ranges from
\(9.84\times10^{-9}\) to \(0.37665\) J across the registered matrix.
These values bound the kinetic change for an ideal sticking impulse at
each sampled state; they are not predictions of realizable grip work or
evidence that sticking improves delivery.

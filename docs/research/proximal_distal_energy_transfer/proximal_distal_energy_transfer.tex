...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Scope and Evidence Categories}, leftrule=.75mm, colframe=quarto-callout-note-color-frame, colback=white, bottomtitle=1mm, opacitybacktitle=0.6, breakable, rightrule=.15mm, toptitle=1mm, titlerule=0mm, toprule=.15mm, bottomrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black]
...
update. Agreement tests transport of one declared reduced mechanism
across two native dynamics engines; it is not independent confirmation
of the contact law or time integrator.

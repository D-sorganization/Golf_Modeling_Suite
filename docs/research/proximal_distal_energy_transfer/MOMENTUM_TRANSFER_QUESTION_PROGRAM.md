...
| Q2  | What are the geometry dependencies?                                                                                    | **Conditionally answered through the spatial mechanism tier.** Force–velocity and relative-link angles, signed grip separation, transverse differential force, reference point, and frame-explicit wrench transport gate sign, zero, and magnitude. A subject-scaled atlas rejects bilateral contact feasibility of the prescribed common states; a bounded follow-up closes all 234 registered reduced-tree configurations. | Executable analytical atlas; exact orthogonal/coincident/axial nulls; force and moment-arm reversals; moving-base controls; independently authored MuJoCo/Pinocchio spatial-contact controls; six synthetic de Leva profiles with prescribed-state and solved-closure audits. | Closed IK passes broad engineering-limit and coarse bounding-sphere screens, not subject-specific clinical ranges, mesh anatomy, calibrated grip compliance, distributed 3-D shaft, participant distribution, or bilateral-wrench evaluation. | Integrate calibrated compliant contact from the closed states in independent engines; replace screening geometry with subject-specific anatomy; then test held-out digital twins and governed human trials.                                              |

...
| Q2  | What are the geometry dependencies?                                                                                    | **Conditionally answered through the spatial mechanism tier.** Force–velocity and relative-link angles, signed grip separation, transverse differential force, reference point, and frame-explicit wrench transport gate sign, zero, and magnitude. A subject-scaled atlas rejects bilateral contact feasibility of the prescribed common states.                | Executable analytical atlas; exact orthogonal/coincident/axial nulls; force and moment-arm reversals; moving-base controls; independently authored MuJoCo/Pinocchio spatial-contact controls; six synthetic de Leva profiles with closure and conditioning audits. | The subject-scaled states miss the grips by 0.171–0.616 m. No closed-contact inverse kinematics, calibrated grip compliance, distributed 3-D shaft, participant distribution, or bilateral-wrench evaluation exists. | Solve closed-contact subject-scaled configurations with joint-limit and collision checks; integrate calibrated compliant contact in independent engines; then test held-out digital twins and governed human trials.                                     |
...
- Reject any prescribed state that fails bilateral anatomical contact closure;
  full local constraint rank is not sufficient. Solve closed-contact inverse
  kinematics with joint limits and collision checks before forward dynamics.

...
| Q2  | What are the geometry dependencies?                                                                                    | **Conditionally answered through the reduced spatial mechanism tier.** Force–velocity and relative-link angles, signed grip separation, transverse differential force, reference point, and frame-explicit wrench transport gate sign, zero, and magnitude. A subject-scaled atlas rejects bilateral contact feasibility of the prescribed common states; a bounded follow-up closes and canonically maps all 234 registered reduced-tree configurations. The hand-carriage reference remains cross-engine coherent through the registered 50 ms horizon, and the articulated tree now passes common-state native inertia parity. | Executable analytical atlas; exact orthogonal/coincident/axial nulls; force and moment-arm reversals; moving-base controls; independently authored MuJoCo/Pinocchio spatial-contact controls; six synthetic de Leva profiles with solved closure, a 2,160-case horizon/adverse-load map, and a 234-state native articulated-inertia audit. | Closed IK, articulated common-state inertia, and 50 ms hand-carriage forwarding pass engineering screens, not subject-specific clinical ranges, mesh anatomy, articulated forward contact, calibrated grip compliance, distributed 3-D shaft, participant distribution, or bilateral-wrench evaluation. The no-failure result is right-censored at 50 ms. | Apply calibrated bilateral contact to the qualified articulated tree; repeat the registered horizon, null, reversal, adverse-load, contact-loss, and refinement controls; then test held-out digital twins and governed human trials. |
...
| Q7  | Is slack beneficial, harmful, or required?                                                                             | **Partly answered and not supported as a general benefit.** Five constitutive classes are separated in the scalar audit. A 1,944-trajectory articulated atlas then compares bilateral, tension-only, and two dead-zone laws under common-displacement and matched-extension controls. The 1.5 mm law changes from open to taut when preload is matched; natural transitions are right-censored at 5 ms. No global benefit, necessity, intentionality, timing economy, or delivery advantage is supported.                                                                                                                         | Scalar class-separation audit plus articulated passive power, work--energy, refinement, opening/reattachment event probes, and MuJoCo--Pinocchio parity.                                                                                                                                                                                   | Synthetic point attachments, short horizon, memoryless radial dead zone, no calibrated friction/distributed grip or shaft, no ground coupling, and no human measurement.                                                                                                                                                                                  | Extend one class at a time through longer matched-state/work/load distributed delivery; add stateful play and subject-specific tissue; acquire independent contact, shaft, tendon, activation, and bilateral-wrench measurements.     |

...
| Q2  | What are the geometry dependencies?                                                                                    | **Conditionally answered through the articulated distributed-contact tier.** Force–velocity and relative-link angles, signed grip separation, transverse differential force, reference point, and frame-explicit wrench transport gate sign, zero, and magnitude. A bounded inverse-kinematics follow-up closes and canonically maps all 234 registered reduced-tree configurations. Native articulated inertia and point-contact projection pass at every state; one-, three-, and five-fiber tension grips then pass nested geometry and refinement controls through 50 ms in 288 trajectories.                                                                    | Executable analytical atlas; exact orthogonal/coincident/axial nulls; force and moment-arm reversals; moving-base controls; independently authored MuJoCo/Pinocchio spatial-contact controls; six synthetic de Leva profiles with solved closure; a 234-state native articulated inertia/contact audit; and one/three/five-fiber coincident, reversal, station-refinement, and active-set tests. | Closed IK and synthetic frictionless fibers pass engineering screens, not subject-specific clinical ranges, mesh anatomy, measured pressure/fingers/tissue, calibrated friction, distributed 3-D shaft, ground pathways, participant distribution, or bilateral-wrench evaluation. The no-transition result is right-censored at 50 ms. | Calibrate grip pressure/friction; add shaft bending/torsion and ground/free-moment pathways separately; repeat matched-state/work/load horizon, null, reversal, adverse-load, contact-loss, and refinement controls; then test held-out digital twins and governed human trials. |

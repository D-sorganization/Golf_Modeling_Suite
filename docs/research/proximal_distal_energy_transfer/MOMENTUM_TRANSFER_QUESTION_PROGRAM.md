...
| Q2  | What are the geometry dependencies?                                                                                    | **Conditionally answered through the finite-base articulated tier.** Force–velocity and relative-link angles, signed grip separation, transverse differential force, reference point, and frame-explicit wrench transport gate sign, zero, and magnitude. All 234 registered reduced-tree configurations close; distributed grip and passive shaft advance selected states through 50 ms. The finite-base extension separates ground force, intrinsic free moment, and transported moment, but its primary coupled--fixed load--total-work screen admits no cell. A 40-sample structural/contact screen retains finite energy-closed responses while partially opening in every local trajectory. A registered seven-corner authority campaign regenerates four headline cases over all 13 phases: six corners retain 52/52 feasible states, while the low-height corner retains one case-0/phase-12 IK nonconvergence. A deterministic preflight binds the resulting 83 feasible headline states and retained failure to the exact atlas designs, authority/model/source hashes, and expected sizes; it is an execution contract, not a propagated result. | Analytical geometry atlas; exact nulls/reversals; native articulated inertia/contact; distributed grip and shaft controls; 576 finite-base pathway/control trajectories with initialization, reference-transport, refinement, domain, energy, and two-engine gates; a governed height, mass, joint-limit, grip, friction, equipment, and velocity LHS screen; digest-bound JSON/NPZ authority for nominal plus low/high height, mass, and joint-limit corners; and `articulated_structural_propagation_plan.json`. | Closed IK and synthetic grip/shaft/support laws pass engineering screens, not subject-specific anatomy, measured pressure/tissue, calibrated equipment, unilateral foot contact, force-plate validation, participant distribution, or bilateral-wrench evaluation. The condition that authority regeneration propagates through both headline estimands remains untested until the checkpointed #8800 campaign qualifies; no propagated result exists yet. The 50 ms result is right-censored and the primary matched outcome is unidentified. The retained low-height numerical failure is not a human feasibility or prevalence result. | Propagate every feasible #8800 authority through the exact scaled native-engine shaft and finite-ground atlases while retaining the low-height failure; calibrate grip, shaft, unilateral foot contact, and force-plate response; then repeat matched-state/work/load horizon, null, reversal, adverse-load, contact-loss, and held-out human tests. |

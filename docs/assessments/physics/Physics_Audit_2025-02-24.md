...
- **Aerodynamics**:
  - Smits, A. J., & Smith, D. R. (1994). A new aerodynamic model of a golf ball. _Science and Golf II_, 340-347.
  - Bearman, P. W., & Harvey, J. K. (1976). Golf ball aerodynamics. _Aeronautical Quarterly_, 27(2), 112-122.
- **Biomechanics**:
  - Nesbit, S. M. (2005). A three dimensional kinematic and kinetic study of the golf swing. _Journal of Sports Science & Medicine_, 4(4), 499.
- **Shaft**:
  - MacKenzie, S. J., & Sprigings, E. J. (2009). A three-dimensional forward dynamics model of the golf swing. _Sports Engineering_, 11(4), 165-175.

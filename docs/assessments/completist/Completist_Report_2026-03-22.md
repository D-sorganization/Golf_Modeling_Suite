...
pie title Completion Status
    "Impl Gaps (Critical)" : 326
    "Feature Requests (TODO)" : 13
    "Technical Debt (FIXME)" : 16
    "Doc Gaps" : 4
```
...
| 17 | `./src/shared/python/pendulum_simulator/perturbation_analysis.py` | __call__ | 5/3/4 |
| 18 | `./src/shared/python/pendulum_simulator/perturbation_analysis.py` | __call__ | 5/3/4 |
| 19 | `./src/shared/python/pendulum_simulator/gui/controls_widget_base.py` | _apply_preset | 5/3/4 |
| 20 | `./src/shared/python/pendulum_simulator/gui/controls_widget_base.py` | get_params | 5/3/4 |

# Completist Report: 2026-03-27

## Executive Summary
- **Critical Gaps**: 352
- **Feature Gaps (TRACKED_TASK)**: 0
- **Technical Debt**: 25
- **Documentation Gaps**: 270

## Visualization
### Status Overview
```mermaid
pie title Completion Status
    "Impl Gaps (Critical)" : 352
...
|---|---|---|---|---|---|
| `./src/api/auth/security.py` | 331 | Stub | 5 | 2 | 4 |
...
| `./src/shared/python/physics/flexible_shaft.py` | 324 | Stub | 5 | 3 | 4 |
| `./src/shared/python/physics/flexible_shaft.py` | 328 | Stub | 5 | 3 | 4 |
| `./src/shared/python/physics/flexible_shaft.py` | 337 | Stub | 5 | 3 | 4 |
| `./src/shared/python/physics/flexible_shaft.py` | 369 | Stub | 5 | 3 | 4 |
...
| `./src/tools/matlab_utilities/scripts/matlab_quality_check.py` | 87 | (r"\bHACK\b", "HACK comment found"), | HACK |
| `./src/tools/matlab_utilities/scripts/matlab_quality_check.py` | 88 | (r"\bXXX\b", "XXX comment found"), | XXX |
...
## Issues Created
- Created `docs/assessments/issues/Issue_2194_Incomplete_Stub_in_security_py_331.md`
...
- Created `docs/assessments/issues/Issue_2200_Incomplete_Stub_in_flexible_shaft_py_324.md`
- Created `docs/assessments/issues/Issue_2201_Incomplete_Stub_in_flexible_shaft_py_328.md`
- Created `docs/assessments/issues/Issue_2202_Incomplete_Stub_in_flexible_shaft_py_337.md`
- Created `docs/assessments/issues/Issue_2203_Incomplete_Stub_in_flexible_shaft_py_369.md`

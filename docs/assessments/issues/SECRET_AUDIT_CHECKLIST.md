...
- [x] `tests/unit/shared_python/ai/adapters/test_gemini_adapter.py` - **False Positive**
  - Contains: Tiny fake API-key fixtures for adapter construction tests
  - Status: Test-only values, no committed secrets

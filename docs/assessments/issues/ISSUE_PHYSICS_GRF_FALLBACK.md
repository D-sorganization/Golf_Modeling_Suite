...
## Description
The `extract_grf_from_contacts` function in `src/shared/python/physics/ground_reaction_forces.py` implements an incorrect fallback mechanism when engine contact data is unavailable:

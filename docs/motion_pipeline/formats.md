...
- **Conversion**:
  ```python
  from src.engines.motion_pipeline.converters import TheiaConverter
...
- **Example**:
  ```python
  from src.engines.motion_pipeline.converters import MediaPipeConverter
...
- **Conversion**:
  ```python
  from src.engines.motion_pipeline.converters import BVHConverter
...
This produces `docs/motion_pipeline/formats.md` from the canonical format definitions in `src/engines/motion_pipeline/formats/`.

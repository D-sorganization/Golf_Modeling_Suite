...
- [x] Hook to derive shot-model parameters from AffineDrift biomechanical simulation output.
- [x] Documentation: "from drift/control decomposition to dispersion parameters."

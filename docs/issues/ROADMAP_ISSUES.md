...
## Phase 7: Strokes Gained Optimizer

### Phase 7.1: Strokes Gained Optimizer (`sg_optimizer`)

- **GitHub Issue**: #6269
- **Status**: Open
- **Description**: [Epic] Strokes Gained Optimizer (`sg_optimizer`) — personalized golf strategy. A new launcher tile and headless library that recommends optimal aim points, club selections, and shot types per hole.

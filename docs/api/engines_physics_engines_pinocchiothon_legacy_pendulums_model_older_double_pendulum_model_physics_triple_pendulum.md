# engines.physics_engines.pinocchiothon.legacy.pendulums_model_older.double_pendulum_model.physics.triple_pendulum
...
##### step
```python
def step(self: Any, t: float, state: TriplePendulumState, dt: float, control: tuple[Any]) -> TriplePendulumState
```

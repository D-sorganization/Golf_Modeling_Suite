...
| `jax`                    | mjx                              | `>=0.4.30`                       | Apache-2.0                            | Commercial-OK          | Optional MJX/JAX differentiable compute stack.                                |
| `jaxlib`                 | mjx                              | `>=0.4.30`                       | Apache-2.0                            | Commercial-OK          | Optional MJX/JAX runtime library; verify accelerator binary terms on release. |
...
| `mujoco-mjx`             | mjx                              | `>=3.6.0`                        | Apache-2.0                            | Commercial-OK          | Optional MuJoCo MJX differentiable backend.                                   |

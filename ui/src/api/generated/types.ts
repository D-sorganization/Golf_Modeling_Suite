...
export interface LauncherTileResponse {
  ...
  /** Declared web/Tauri reachability contract */
...
export interface WebLaunchContractResponse {
  /** Web reachability mode for the tile */
  mode: "route" | "native-window" | "unavailable";
  /** React route for mode='route' tiles */
  route?: string | null;
  /** Why the tile is unavailable from the web shell */
  reason?: string | null;
}

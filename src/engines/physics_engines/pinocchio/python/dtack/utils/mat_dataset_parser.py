"""Parser for proprietary mocap-capture binary files (.gpcap)."""
...
class MatDatasetParser:
    """Parser for proprietary mocap-capture .gpcap binary files."""

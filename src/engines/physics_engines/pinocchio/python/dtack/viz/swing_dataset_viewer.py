"""Python wrapper for swing-dataset club visualization.

This module provides visualization capabilities for golf club swing-dataset
recordings (e.g. .mat files of clubhead/midhands trajectories), inspired by
the MATLAB ClubDataGUI_v2.m functionality.
...
class SwingDatasetViewer:
    """Visualize golf club swing-dataset .mat files in MeshCat.
    ...
    def __init__(self, zmq_url: str = "tcp://127.0.0.1:6000") -> None:
        """Initialize swing-dataset viewer.
        ...
        logger.info("Swing-dataset viewer initialized")

    def load_data(self, mat_file: Path | str) -> None:
        """Load swing-dataset .mat file.

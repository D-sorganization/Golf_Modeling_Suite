"""Grip scene XML construction helpers.

Provides static utilities for preparing MuJoCo scene XML for hand-grip modelling:
  - inlining hand includes
  - ensuring offscreen visual settings
  - injecting cylinder grip objects
  - injecting mocap bodies and weld constraints

Extracted from grip_modelling_tab.py as part of issue #3060 refactor.
"""
...
class GripSceneXmlBuilder:
    """Builds and patches MuJoCo scene XML for hand-grip scenarios."""
    ...
    def prepare_scene_xml(
        ...
        Args:
            ...
            folder_path: Directory containing hand asset XML files.
            is_both: Whether to load both hands simultaneously.

        Returns:
            Patched XML string ready for MuJoCo loading.
        """

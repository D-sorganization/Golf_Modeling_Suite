...
BALL_MASS = (
    float(_ball_mass_param.value) if _ball_mass_param else float(constants.GOLF_BALL_MASS_KG)
)
BALL_RADIUS = (
    float(_ball_radius_param.value) if _ball_radius_param else float(constants.GOLF_BALL_RADIUS_M)
)

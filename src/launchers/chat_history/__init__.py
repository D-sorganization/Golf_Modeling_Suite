...
export / load_as_context`` — and, optionally, shared chat memory
condensation (``condense_to_memory``); the adapter falls back to explicit
diagnostics when no concrete condenser is wired.
"""

...
from PyQt6.QtGui import QIcon, QPixmap, QPainter, QEnterEvent
from PyQt6.QtWidgets import QTextBrowser, QPushButton, QApplication, QWidget
...
class HoverCopyTextBrowser(QTextBrowser):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        svg_data = b"""<svg viewBox="0 0 24 24" width="16" height="16" stroke="#ffffff" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
    ...
    def leaveEvent(self, event: QEvent | None) -> None:
        """Hide copy button when mouse leaves, unless hover is directly on the button."""

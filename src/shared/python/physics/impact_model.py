...
@precondition(
    lambda impact_offset, clubhead_velocity, clubface_normal, gear_factor=0.5, h_scale=100.0, v_scale=50.0: (  # fmt: skip
        0 <= gear_factor <= 1
    ),
...
class ImpactSolverAPI:
    ...
    @precondition(
        lambda self, timestamp, clubhead_velocity, clubhead_orientation, ball_velocity=None, ball_angular_velocity=None, clubhead_mass=0.200, record=True: (  # fmt: skip
            clubhead_mass > 0
        ),
        "Clubhead mass must be positive",
    )

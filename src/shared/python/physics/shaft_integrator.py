"""Shaft numerical integration: finite element model and static analysis.

Provides:
- FiniteElementShaftModel — Euler-Bernoulli beam FE model with Newmark-beta time integration
- compute_static_deflection — analytical cantilever deflection under point load
- create_shaft_model — factory function for all shaft model types
...
from src.shared.python.physics.shaft_model import (
    ModalShaftModel,
    RigidShaftModel,
    ShaftModel,
    compute_EI_profile,

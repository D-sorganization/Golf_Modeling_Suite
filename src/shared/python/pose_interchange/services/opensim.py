...
:class:`opensim.Model`. It handles loading the model, setting the coordinate values
from a :class:`CanonicalPose`, querying link transforms in the ground frame,
stepping the simulation state using :class:`opensim.Manager`, and resetting
the simulation.

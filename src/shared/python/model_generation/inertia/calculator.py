...
class InertiaMode(Enum):
    ...
    # ("primitive") so it resolves to the same enum member. Kept until the
    # legacy callers are migrated. See #4600.
    PRIMITIVE_APPROXIMATION = "primitive"  # noqa: PIE796 (intentional alias)

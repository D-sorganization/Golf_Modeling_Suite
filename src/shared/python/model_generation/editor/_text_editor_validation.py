"""URDF validation mixin for the text editor.

Provides :class:`_URDFValidationMixin` which is mixed into
:class:`URDFTextEditor` to supply all URDF/XML validation methods.
"""
...
class _URDFValidationMixin:
    """Mixin providing URDF and XML validation for URDFTextEditor."""

    # _content is provided by URDFTextEditor.__init__

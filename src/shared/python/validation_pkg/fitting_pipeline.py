"""SensitivityAnalyzer and A3FittingPipeline for the A3 fitting pipeline.

Extracted from data_fitting.py (issue #3060).

This module contains the high-level orchestration classes and sensitivity
analysis that depend on the lower-level models and solvers.
"""
...
from ._data_fitting_solvers import ParameterEstimator
...
__all__ = ["A3FittingPipeline", "SensitivityAnalyzer"]

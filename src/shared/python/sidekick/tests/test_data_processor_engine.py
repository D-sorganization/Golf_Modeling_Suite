...
"""Comprehensive tests for sidekick.data_processing.core.DataProcessorEngine.
...
class TestLoadFile:
    ...
    def test_permission_error_raises(self):
        ...
        with (
            patch(
                "sidekick.data_processing.core.DataReader.read_file",
...
class TestExportData:
    ...
    def test_export_success(self):
        engine = _make_engine_with_data()
        with patch("sidekick.data_processing.core.DataWriter.write_file") as mock_write:
    ...
    def test_export_oserror_raises(self):
        ...
        with (
            patch(
                "sidekick.data_processing.core.DataWriter.write_file",

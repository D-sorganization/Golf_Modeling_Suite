...
class InputPanel(QWidget):
    ...
    def _create_operating_parameters_group(self) -> QGroupBox:
        ...
        self.s2_recycle_slider = create_slider(
            ...
            value_changed_callback=lambda v: self.s2_recycle_label.setText(f"{v}%"),  # type: ignore[arg-type]
        )
        ...
        self.prod_recycle_slider = create_slider(
            ...
            default_value=0,
            orientation=Qt.Orientation.Horizontal,
            value_changed_callback=lambda v: self.prod_recycle_label.setText(f"{v}%"),  # type: ignore[arg-type]
        )

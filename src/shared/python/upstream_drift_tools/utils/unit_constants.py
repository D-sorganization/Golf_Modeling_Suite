...
CAL_PER_GRAM_CELSIUS_TO_J_PER_KG_K: Final[float] = _t("CAL_PER_GRAM_CELSIUS_TO_J_PER_KG_K", 4186.8)
...
CENTISTOKE_TO_SQ_METER_PER_SECOND: Final[float] = _t("CENTISTOKE_TO_SQ_METER_PER_SECOND", 1e-06)
...
GRAM_PER_CU_CM_TO_KG_PER_CU_METER: Final[float] = _t("GRAM_PER_CU_CM_TO_KG_PER_CU_METER", 1000.0)
GRAM_PER_LITER_TO_KG_PER_CU_METER: Final[float] = _t("GRAM_PER_LITER_TO_KG_PER_CU_METER", 1.0)
GRAM_PER_SECOND_TO_KG_PER_SECOND: Final[float] = _t("GRAM_PER_SECOND_TO_KG_PER_SECOND", 0.001)
...
IMPERIAL_GALLON_TO_CU_METER: Final[float] = _t("IMPERIAL_GALLON_TO_CU_METER", 0.00454609)
...
KG_PER_CU_METER_TO_KG_PER_CU_METER: Final[float] = _t("KG_PER_CU_METER_TO_KG_PER_CU_METER", 1.0)
...
US_FLUID_OUNCE_TO_CU_METER: Final[float] = _t("US_FLUID_OUNCE_TO_CU_METER", 2.95735295625e-05)

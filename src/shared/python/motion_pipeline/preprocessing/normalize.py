...
def normalize_coordinates(
    ...
    source_up: Optional[UpAxis] = None,
...
def convert_units(
    ...
    source_unit: Optional[UnitSystem] = None,
) -> KeypointSequence | MarkerTrajectory:
    """
...
def _convert_keypoint_units(
    ...
    source_unit: Optional[UnitSystem],
) -> KeypointSequence:
...
def _detect_up_axis_keypoints(frames: list[KeypointFrame]) -> UpAxis:
    ...
    if var_y > var_x and var_y > var_z:
        return UpAxis.Y_UP
    elif var_z > var_x and var_z > var_y:
        return UpAxis.Z_UP
    else:
        return UpAxis.X_UP

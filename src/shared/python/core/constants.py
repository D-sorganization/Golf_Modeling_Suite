...
from .physics_constants import (  # noqa: F401
    AIR_DENSITY_SEA_LEVEL_KG_M3 as AIR_DENSITY_SEA_LEVEL_KG_M3,
)
...
from .physics_constants import M_TO_YARD as M_TO_YARD  # noqa: F401
...
GUI_LAUNCHER_SCRIPT: Path = Path("src/launchers/upstream_drift_launcher.py")
...
LOCAL_LAUNCHER_SCRIPT: Path = Path("src/launchers/upstream_drift_launcher.py")

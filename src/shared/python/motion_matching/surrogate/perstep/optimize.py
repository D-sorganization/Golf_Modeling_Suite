...
from .train import DynamicsMLP

try:  # pragma: no cover - import path differs across deployments
    from export_torque_polynomials import TORQUE_TO_POLYNOMIAL_BASE
except ImportError:  # pragma: no cover - fall back to engine-local module
    import sys

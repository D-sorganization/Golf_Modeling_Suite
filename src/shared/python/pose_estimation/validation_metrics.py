...
def compute_marker_rmse(
    ...
    # Per-marker RMSE
    # ⚡ Bolt: Explicit element-wise calculation avoids np.linalg.norm reduction overhead for small inner dims
    squared_errors = np.sum((pred - ref) ** 2, axis=2)  # [frames x markers]

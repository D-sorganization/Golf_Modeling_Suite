"""
Primitive mesh generator backend for humanoid character builder.

Generates simple geometric shapes (capsules, cylinders, boxes, spheres) for
each body segment using trimesh. No external body-model dependencies required.
"""

"""
MakeHuman mesh generator backend for humanoid character builder.

Integrates with MakeHuman to produce high-quality segmented body meshes.
Falls back gracefully when MakeHuman is not installed.
"""
    ...
    def _generate_via_api(
        ...
        **kwargs: Any,
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            from humanoid_character_builder.generators.mesh_smplx import (
                SMPLXMeshGenerator,
            )

"""
SMPL-X mesh generator backend for humanoid character builder.

Uses the SMPL-X differentiable body model (learned from thousands of 3D body
scans) to produce high-fidelity segmented body meshes.
"""

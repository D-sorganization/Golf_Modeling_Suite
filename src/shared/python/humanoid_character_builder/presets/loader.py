...
_BUILTIN_PRESETS: dict[str, dict[str, Any]] = {
    ...
    "child_8yo": {
        ...
        "hip_width_factor": 0.80,
        "arm_length_factor": 0.85,
        "leg_length_factor": 0.85,
        "description": "8-year-old child anthropometry (CDC growth charts, 50th percentile)",
        "citation": "CDC Growth Charts 2000: https://www.cdc.gov/growthcharts/cdc_charts.htm",
    },
    "senior_70yo": {
        "height_m": 1.70,
        "mass_kg": 72.0,
        ...
        "gender_model": GenderModel.NEUTRAL,
        "muscularity": 0.35,
        "body_fat_factor": 0.28,
        "shoulder_width_factor": 0.95,
        "hip_width_factor": 1.0,
        "arm_length_factor": 0.98,
        "leg_length_factor": 0.97,
        "description": "70-year-old senior anthropometry (NHANES data, average)",
        "citation": "NHANES Anthropometric Data: https://www.cdc.gov/nchs/nhanes/",
    },
    "tall_male": {
        "height_m": 1.93,
        "mass_kg": 88.0,
        ...
        "hip_width_factor": 0.98,
        "arm_length_factor": 1.05,
        "leg_length_factor": 1.06,
        "description": "Tall male (95th percentile height, CDC)",
        "citation": "CDC Anthropometric Reference Data: https://www.cdc.gov/nchs/data/series/sr_03/sr03_039.pdf",
    },
    "petite_female": {
        "height_m": 1.55,
        "mass_kg": 52.0,
        ...
        "gender_model": GenderModel.FEMALE,
        "muscularity": 0.4,
        "body_fat_factor": 0.22,
        "shoulder_width_factor": 0.92,
        "hip_width_factor": 1.02,
        "arm_length_factor": 0.95,
        "leg_length_factor": 0.94,
        "description": "Petite female (5th percentile height, CDC)",
        "citation": "CDC Anthropometric Reference Data: https://www.cdc.gov/nchs/data/series/sr_03/sr03_039.pdf",
    },
    "pro_golfer_male": {
        "height_m": 1.83,
        ...
        "muscularity": 0.65,
        "body_fat_factor": 0.12,
        "shoulder_width_factor": 1.10,
        "hip_width_factor": 0.95,
        "arm_length_factor": 1.02,
        "leg_length_factor": 1.0,
        "torso_length_factor": 1.0,
        "description": "Male professional golfer (PGA Tour average anthropometry)",
        "citation": "Synthetic, derived from PGA Tour player anthropometric studies (Hume et al., 2005)",
    },
    "pro_golfer_female": {
        "height_m": 1.68,
        "mass_kg": 64.0,
        ...
        "leg_length_factor": 1.0,
        "torso_length_factor": 1.0,
        "description": "Female professional golfer (LPGA Tour average anthropometry)",
        "citation": "Synthetic, derived from LPGA Tour player anthropometric studies (Hume et al., 2005)",
    },
}
...
def get_preset_info(preset_name: str) -> dict[str, Any]:
    ...
    return {
        ...
        "citation": preset_data.get("citation", ""),
    }

...
from src.shared.python.launch_monitor.relationships import compute_correlations
...
def analyze_variables(
    ...
    if is_aggregate:
        warnings.append(
            "Aggregate correlations are descriptive only and may exhibit ecological bias."
        )
    if (

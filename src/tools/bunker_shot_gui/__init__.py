...
* :mod:`~src.tools.bunker_shot_gui.design`,
  :mod:`~src.tools.bunker_shot_gui.model` and
  ...
  DRFT solver, the W7 designer metrics, the playability window and the A/B
  ranking -- can be run and tested with no display, and can back the
  Tauri/React app.

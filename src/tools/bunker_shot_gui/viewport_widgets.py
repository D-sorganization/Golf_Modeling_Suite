"""The 3-D scene, the trace panel and the sand cut, as Qt views.

Issues #8706, #8708 and #8711.
...
:mod:`~.shot3d`'s, :mod:`~.traces`' and :mod:`~.slices`', the drawing is
:mod:`~.render3d`'s, :mod:`~.render_traces`' and :mod:`~.render_slice`',
which is why the same figures can be produced in a headless test. These
classes own a canvas, a selector, and the knowledge of when to repaint.
...
from .slices import CursorMap, CuttingPlane, SliceScale, preset_planes, slice_scale

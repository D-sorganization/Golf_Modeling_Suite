...
@pytest.mark.skipif(C3DViewerMainWindow is None, reason="Could not import C3DViewerMainWindow")
class TestHeadlessSuite:
    ...
    def test_file_loading_trigger(self, qtbot, mock_loader_thread):
        ...
        with patch("PyQt6.QtWidgets.QFileDialog.getOpenFileName") as mock_dialog:
            ...
            with patch("src.shared.python.security.security_utils.validate_path") as mock_validate:

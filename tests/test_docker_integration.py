...
class TestDockerBuild(unittest.TestCase):
    ...
    def test_dockerfile_syntax(self):
        ...
        self.assertIn("FROM continuumio/miniconda3:24.11.1-0@sha256:6a66425f001f739d4778dd732e020afeb06175f49478fafc3ec673658d61550b AS builder", content)
        self.assertIn("FROM continuumio/miniconda3:24.11.1-0@sha256:6a66425f001f739d4778dd732e020afeb06175f49478fafc3ec673658d61550b AS runtime", content)

...
class TestEquilibriumResidual:
    ...
    def test_residual_changes_sign_across_equilibrium(self, standard_muscle):
        ...
        residual_short = solver._equilibrium_residual(l_CE_eq * 0.95, l_MT, activation, v_CE=0.0)

        # Test slightly longer fiber (less tendon force)
        residual_long = solver._equilibrium_residual(l_CE_eq * 1.05, l_MT, activation, v_CE=0.0)
...
class TestSolveFiberLength:
    ...
    def test_convergence_at_different_lengths(self, standard_muscle):
        ...
        assert solutions[0] < solutions[-1], "Longer muscle-tendon should have longer fiber"
    ...
    def test_solution_satisfies_bounds(self, standard_muscle):
        ...
        assert (
            0.5 * standard_muscle.params.l_opt < l_CE < 2.0 * standard_muscle.params.l_opt
...
class TestPhysicalRealism:
    ...
    def test_tendon_bears_load_when_stretched(self, standard_muscle):
        ...
        assert l_tendon_long > l_tendon_short, "Longer muscle-tendon should stretch tendon more"
...
class TestNumericalAccuracy:
    ...
    def test_solver_convergence_with_good_guess(self, standard_muscle):
        ...
        l_CE_with_guess = solver.solve_fiber_length(l_MT, activation, initial_guess=l_CE_answer)
...
class TestEdgeCases:
    ...
    def test_very_long_muscle_tendon(self, standard_muscle):
        ...
        assert l_CE > standard_muscle.params.l_opt, "Long muscle-tendon should have stretched fiber"

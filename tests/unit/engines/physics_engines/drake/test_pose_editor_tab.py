...
class TestDrakePoseEditor:
    @patch("src.engines.physics_engines.drake.python.src.pose_editor_tab.RevoluteJoint", type("RevoluteJoint", (), {}))
    @patch("src.engines.physics_engines.drake.python.src.pose_editor_tab.PrismaticJoint", type("PrismaticJoint", (), {}))

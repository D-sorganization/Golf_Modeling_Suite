...
class TestGolfURDFGenerator:
    ...
    def test_transform_to_origin_xml(self, generator: GolfURDFGenerator) -> None:
        ...
        with patch("src.engines.physics_engines.drake.python.src.drake_golf_model.RollPitchYaw") as mock_rpy:
    ...
    def test_generate_urdf(self, generator: GolfURDFGenerator) -> None:
        ...
        with patch("src.engines.physics_engines.drake.python.src.drake_golf_model.UnitInertia") as mock_unit_inertia:
            ...
            with patch("src.engines.physics_engines.drake.python.src.drake_golf_model.RigidTransform") as mock_rt, \
                 patch("src.engines.physics_engines.drake.python.src.drake_golf_model.RollPitchYaw") as mock_rpy:
...
class TestDrakeGolfModelBuilderFunctions:
    ...
    def test_add_joint_actuators(self) -> None:
        ...
        with patch("src.engines.physics_engines.drake.python.src.drake_golf_model.JointIndex", side_effect=lambda x: x):
    ...
    @patch("src.engines.physics_engines.drake.python.src.drake_golf_model.AddMultibodyPlantSceneGraph")
    @patch("src.engines.physics_engines.drake.python.src.drake_golf_model.DiagramBuilder")
    @patch("src.engines.physics_engines.drake.python.src.drake_golf_model.GolfURDFGenerator")

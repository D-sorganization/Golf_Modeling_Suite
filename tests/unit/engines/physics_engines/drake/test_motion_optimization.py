...
class TestDrakeMotionOptimizerSetup:
    ...
    def test_setup_standard_golf_constraints(
        self, optimizer: DrakeMotionOptimizer
    ) -> None:
...
class TestDrakeMotionOptimizerOptimization:
    ...
    def test_optimize_trajectory_none_initial(
        self, optimizer: DrakeMotionOptimizer
    ) -> None:
    ...
    def test_optimize_for_distance(
        ...
        result = optimizer.optimize_for_distance(
            initial_trajectory, target_distance=300.0
        )
    ...
    def test_optimize_for_accuracy(
        ...
        result = optimizer.optimize_for_accuracy(
            initial_trajectory, target_point=target
        )

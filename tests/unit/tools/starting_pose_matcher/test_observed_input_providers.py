...
def test_openpose_parse_json_fixture():
    ...
    from src.tools.starting_pose_matcher.providers.openpose import OpenPoseProvider
        ...
        "people": [
            {
                "pose_keypoints_2d": [
                    100, 100, 0.9,  # nose
                    100, 120, 0.9,  # neck
                    120, 130, 0.9,  # right_shoulder
                    130, 150, 0.9,  # right_elbow
                    140, 170, 0.9,  # right_wrist
                    80, 130, 0.9,   # left_shoulder
                    70, 150, 0.9,   # left_elbow
                    60, 170, 0.9,   # left_wrist
                    115, 200, 0.9,  # right_hip
                    120, 250, 0.5,  # right_knee
                    125, 300, 0.5,  # right_ankle
                    85, 200, 0.9,   # left_hip
                    80, 250, 0.5,   # left_knee
                    75, 300, 0.5,   # left_ankle
                    105, 95, 0.8,   # right_eye
                    95, 95, 0.8,    # left_eye
                    110, 90, 0.7,   # right_ear
                    90, 90, 0.7,    # left_ear
                ]
            }
        ]
...
def test_openpose_confidence_thresholding():
    ...
    fixture = {
        "people": [
            {
                "pose_keypoints_2d": [
                    100, 100, 0.1,  # nose - low confidence
                    100, 120, 0.1,  # neck - low confidence
                    120, 130, 0.9,  # right_shoulder - high confidence
                    130, 150, 0.1,  # right_elbow - low confidence
                    140, 170, 0.9,  # right_wrist - high confidence
                    80, 130, 0.9,   # left_shoulder - high confidence
                    70, 150, 0.1,   # left_elbow - low confidence
                    60, 170, 0.9,   # left_wrist - high confidence
                    115, 200, 0.9,  # right_hip - high confidence
                    120, 250, 0.1,  # right_knee - low confidence
                    125, 300, 0.1,  # right_ankle - low confidence
                    85, 200, 0.9,   # left_hip - high confidence
                    80, 250, 0.1,   # left_knee - low confidence
                    75, 300, 0.1,   # left_ankle - low confidence
                    105, 95, 0.1,   # right_eye - low confidence
                    95, 95, 0.1,    # left_eye - low confidence
                    110, 90, 0.1,   # right_ear - low confidence
                    90, 90, 0.1,    # left_ear - low confidence
                ]
            }
        ]
    }
...
def test_openpose_create_provider():
    ...
    from src.tools.starting_pose_matcher.providers.openpose import create_provider
...
def test_mediapipe_parse_landmarks():
    ...
    from src.tools.starting_pose_matcher.providers.mediapipe import MediaPipeProvider
...
def test_mediapipe_create_provider():
    """Test create_provider function."""
    from src.tools.starting_pose_matcher.providers.mediapipe import create_provider
...
def test_observed_input_providers_distinct_from_physics():
    ...
    from src.tools.starting_pose_matcher.providers.openpose import KeypointObservation
    from src.tools.starting_pose_matcher.providers.mediapipe import LandmarkObservation

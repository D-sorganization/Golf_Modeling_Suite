...
def test_provider_with_q_config():
    ...
    import tempfile
    import numpy as np
    from src.tools.starting_pose_matcher.providers.pinocchio import PinocchioSkeletonProvider
...
def test_get_available_frames():
    ...
    try:
        ...
        expected_frames = ["hip", "spine", "torso", "hub", "left_shoulder", "right_shoulder",

...
<mujoco model="minimal_golfer">
  ...
  <worldbody>
          ...
          <body name="hub" pos="0 0 0.1">
            ...
            <body name="left_shoulder" pos="0.1 0 0">
              ...
              <body name="left_elbow" pos="0.1 0 0">
                <geom type="sphere"/>
                <body name="left_wrist" pos="0.1 0 0"><geom type="sphere"/></body>
              </body>
            </body>
            <body name="right_shoulder" pos="-0.1 0 0">
              ...
              <body name="right_elbow" pos="-0.1 0 0">
                <geom type="sphere"/>
                <body name="right_wrist" pos="-0.1 0 0"><geom type="sphere"/></body>
              </body>
            </body>
          </body>
        </body>
    ...
    <body name="midpoint" pos="0 0 0.5"><geom type="sphere"/></body>
    <body name="clubhead" pos="0 0 0.6"><geom type="sphere"/></body>
  </worldbody>
</mujoco>
"""

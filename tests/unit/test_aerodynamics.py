...
class TestDragModel:
    ...
    @pytest.mark.xfail(strict=False, reason="DragModel physics not fully quadratic in current impl")
    ...
    @pytest.mark.xfail(strict=False, reason="DragModel coefficient effect not working in current impl")

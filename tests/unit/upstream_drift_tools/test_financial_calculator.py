"""Tests for src.shared.python.upstream_drift_tools.process_calculators.financial_calculator (Issues #1949, #1744)."""

from __future__ import annotations

import pytest

from src.shared.python.upstream_drift_tools.process_calculators.financial_calculator import (

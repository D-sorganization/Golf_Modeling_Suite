"""Tests for src.shared.python.sidekick.calculators.thermo.thermo_properties (Issues #1949, #1744)."""

from __future__ import annotations

from src.shared.python.sidekick.calculators.thermo.thermo_properties import (
    MOLAR_CP_298,
    MOLECULAR_WEIGHTS,
    R_GAS,

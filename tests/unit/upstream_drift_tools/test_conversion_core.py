"""Tests for src.shared.python.sidekick.calculators.conversion.core (Issues #1949, #1744)."""

from __future__ import annotations

import pytest
from src.shared.python.sidekick.calculators.conversion.core import (
    convert_temperature,
    convert_via_table,
    scfm_to_standard_m3_per_hour,
    standard_m3_per_hour_to_scfm,
)
from src.shared.python.sidekick.calculators.conversion.tables import (
    StandardCondition,
)

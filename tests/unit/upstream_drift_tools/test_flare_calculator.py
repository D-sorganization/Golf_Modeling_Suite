"""Tests for src.shared.python.sidekick.process_calculators.flare_calculator (Issues #1949, #1744)."""

from __future__ import annotations

import pytest
from src.shared.python.sidekick.process_calculators.flare_calculator import (
    GAS_PROPERTIES,
    FlareCalculator,
    FlareDesign,
)

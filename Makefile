...
sync-deps:
	...
	python3 -m piptools compile --custom-compile-command="pip-compile --extra=dev --extra=gui-test --output-file=requirements-dev.lock pyproject.toml" --extra dev --extra gui-test -o requirements-dev.lock pyproject.toml

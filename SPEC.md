...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-09 | 1.0.66  | Perf(norm-reductions): Replaced high-overhead `np.linalg.norm(..., axis=1)` calls with explicit dimension-agnostic coordinate math (`np.sqrt(np.sum(np.square(...)))`) in `src/research/deformable/objects.py` and `src/shared/python/config/handedness_support.py` to boost performance.                                                                                                                                                                                                                                                                                        |

...
| **Last Spec Update**    | 2026-05-08 (issue #4397 - reproducible 3D fullbody logging-prune audit schema, docs, and static/MATLAB schema harnesses) |
...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-08 | 1.0.144 | Added a reproducible 3D fullbody logging-prune audit layer for `src/engines/Simscape_Multibody_Models/3D_FullBody_Model/matlab/scripts/prune_redundant_logging.m`, including machine-readable JSON schema fields, human-readable audit docs, dry-run candidate reporting, downstream signal allowlist preservation, and static/MATLAB schema harnesses that keep heuristic block-savings estimates separate from measured before/after block and signal counts. |

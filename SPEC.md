...
- Theme Colors dynamic token resolution: ensure declared class attributes on Colors (e.g. PRIMARY, BG_BASE, TEXT_PRIMARY, ACCENT) dynamically delegate to active theme palette via `_ColorsMeta.__getattribute__` interception without shadowing theme updates (#9037).

...
| 2026-05-01 | 1.0.87  | Bolt: Optimized `np.linalg.norm(..., axis=1)` to explicit element-wise computation using `np.einsum` in `fit_sphere` for bounding sphere radius computation |

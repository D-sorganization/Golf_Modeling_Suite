...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-01 | 1.0.228 | Hardened the API/security surface for issues #6926-#6929: dataset import paths are contained against traversal (`src/api/utils/path_validation.py`, `src/api/routes/dataset.py`), realtime publish payloads are bounded (`src/api/routes/realtime.py`), engine-adapter XML reads are XXE-safe (`_mjcf_io.py`, `_urdf_io.py`, `opensim.py`, `pose_io.py`), the `.drake` pickle trust boundary is documented, and the Semgrep `sql-injection-using-db-cursor-execute` finding on `ControlFeaturesRegistry.execute()` in `dataset.py` is suppressed inline as a false positive (in-process control/analysis feature dispatch, no DB cursor or SQL). |

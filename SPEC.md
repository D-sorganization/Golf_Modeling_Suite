...
| **Last Spec Update**    | 2026-05-08 (3D full-body validation gate)          |
...
| 3D Full-Body Simscape Scaffold | `src/engines/Simscape_Multibody_Models/3D_FullBody_Model/` | Build-from-source derivative of the 3D golf Simscape model with leg-chain design docs, MATLAB build scripts, generated `.slx` exclusion, validation gate schema, and load/simulation smoke-test harness |
...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-08 | 1.0.144 | Added a versioned `3D_FullBody_Model` validation gate contract for Home-license nonvirtual block budget, warning threshold, required signal allowlist, generated model timestamp/hash metadata, leg/contact phase detection, smoke-simulation status, and static Python report-shape tests. |

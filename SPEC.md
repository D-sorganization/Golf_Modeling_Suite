...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-20 | 1.0.131 | Docker/Security: Rebuilt the slim Docker runtime onto `python:3.12-slim-bookworm` to drastically reduce image size (target budget ~4,000 MB). Lazy-loads the PyQt6 dashboard to keep GUI dependencies out of the API runtime. Addressed Trivy alerts for Debian OpenSSL packages, pip vulnerability (upgraded >=25.3), and simpleeval vulnerability (upgraded >=1.0.5). |

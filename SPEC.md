...
| 2026-04-15 | 1.0.123 | CI stabilization: trajectory analysis performance coverage now keeps a CI-safe wall-clock ceiling and a per-step scaling check instead of depending on a brittle sub-half-second absolute threshold on instrumented self-hosted Python 3.12 runners.                                                                                                                                                                                                                                                                                                                                                                                       |

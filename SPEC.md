...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-17 | 1.0.126 | Code quality: eliminated 4076 instances of the `if not x is not None:` double-negative antipattern across 665 source files, replacing each with the idiomatic `if x is None:` form. Also fixed the compound mutual-exclusion check in `src/api/aip/dispatcher.py`, moved four root-level maintenance scripts (`count_prints.py`, `count_prints_ast.py`, `patch_analyzers.py`, `replace_prints.py`) into `scripts/`, and updated pre-commit config to use `python3` instead of `python3.11`. No behavior changes.                                                                                                                      |

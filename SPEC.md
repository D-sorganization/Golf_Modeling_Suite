...
| 2026-04-29 | 1.0.11  | Bolt: Replaced `np.linalg.norm` with `math.hypot` for 3D vector distance optimization in `_primitive_shapes.py`. |
| 2026-04-01 | 1.0.11  | Bolt: Replaced `np.linalg.norm` with `math.hypot` for 3D vector distance optimization in `_primitive_shapes.py`. |

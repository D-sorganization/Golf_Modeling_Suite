...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-25 | 1.0.594 | Fixed the #8358 Tools provider-contract test harness so refreshing one selected provider no longer evicts the entire downstream-owned `src.shared` namespace. The regression preserves an already-imported UpstreamDrift perturbation gateway when Tools is first on `PYTHONPATH`, while the existing contracts still require every selected provider to resolve from Tools. This changes no production import, public API, provider schema, vendor pin, workflow, or runner; it restores deterministic downstream compatibility verification for Tools PR #4734. |

...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-10 | 1.0.306 | Docker build timeout enforcement for #7277. `DockerManager` now monitors build output through a background queue while enforcing a wall-clock build timeout, terminating the process tree when stdout remains open past the deadline and covering that hung-output regression with launcher unit tests. |
| 2026-06-10 | 1.0.303 | Coverage gate fix for #7273. Standard CI now sends PRs that change source, tests, or dependency targets through the coverage-producing core test lane instead of the workflow-only `--no-cov` shortcut, and per-package coverage enforcement runs whenever that lane emits `coverage.xml`. |

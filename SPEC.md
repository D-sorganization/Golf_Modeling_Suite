...
| 2026-05-02 | 1.0.88  | Bolt: Fixed #3691 by replacing inefficient math.hypot unpacking on numpy arrays with optimal np.sqrt(np.vdot(x, x)) vector math in collision calculation modules. |

...
| 2026-04-07 | 1.0.59  | Perf(simscape-3d-analysis): refreshed the vector-reduction optimization branch onto the latest shared PR branch and current `main` history, preserving the explicit small-array NumPy reduction speedup in the 3D golf C3D analysis service and plotting tabs while clearing stale merge state.                                                                                                                                                                                                                                                                                                                                  |

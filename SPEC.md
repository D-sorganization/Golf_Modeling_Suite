...
|------|---------|---------|
| 2026-03-31 | 1.0.6 | Fixed insecure deserialization vulnerability by explicitly adding `allow_pickle=False` to all `np.load` calls in data IO and physics engine modules. |

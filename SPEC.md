...
| 2026-04-14 | 1.0.94  | Fix(DbC): replaced bare assert statements in script_utils.py with explicit ValueError/TypeError raises to preserve validation under python -O; added tests to confirm error paths.                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

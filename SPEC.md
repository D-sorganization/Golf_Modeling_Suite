...
| 2026-05-03 | 1.0.101 | Tightened the security/dependency guardrails for issue #3844 by pinning `python-dotenv>=1.2.2`, pruning stale pip-audit waivers, and sending stale-waiver diagnostics to stderr so CI fails cleanly before invoking `pip-audit`. |

...
- Replaced `np.linalg.norm` with `math.hypot` for single-vector Euclidean norm computation, bypassing numpy overhead for ~1.5x speedup (spec-exempt: micro-optimization)

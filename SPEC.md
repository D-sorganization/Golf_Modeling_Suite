...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-22 | 1.0.572 | Made the classic launcher application lifecycle single-owner and restart-safe for embedded and test-hosted execution. `run_launcher` now reuses `QApplication.instance()` and constructs an application only when none exists, preventing the Python 3.11/3.12 full-suite exit-139 failure caused by a second Qt application object. Focused regressions enforce both lifecycle branches without entering an uncontrolled event loop. |

...
| 2026-04-28 | 1.0.4   | Performance optimization: Replaced `np.sum(diff**2, axis=0)` with `np.einsum` to optimize batched sum of squares computations in aerodynamics calculations. |
...
| 2026-04-28 | 1.0.0   | Initial specification for UpstreamDrift v2.1.0; documented all 14 features, architecture, testing strategy, and CI/CD pipeline                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |

...
| 2026-05-07 | 1.0.144 | Relocated `starting-pose-matcher` from nested MATLAB path `src/engines/Simscape_Multibody_Models/3D_Golf_Model/matlab/src/apps/golf_gui/Motion Capture Plotter/` to canonical tools location `src/tools/starting_pose_matcher/` with deprecation shim and comprehensive test suite (issue #4376). |
````

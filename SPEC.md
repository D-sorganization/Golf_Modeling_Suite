...
| 2026-05-02 | 1.0.81  | Bolt: Replaced `np.sqrt(np.vdot)` with `math.hypot` in `src/robotics/planning/collision/collision_checker.py` to further optimize norm calculation for tiny 3D geometric vectors, addressing GitHub Issue #3648. |

...
| **Last Spec Update**    | 2026-05-08 (3D full-body mirrored leg contact)     |
...
| 3D Full-Body Simscape Scaffold | `src/engines/Simscape_Multibody_Models/3D_FullBody_Model/` | Build-from-source derivative of the 3D golf Simscape model with scripted mirrored-leg/contact slices, leg-chain design docs, MATLAB build scripts, generated `.slx` exclusion, and load/simulation smoke-test harness |
...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-08 | 1.0.145 | Mirrored the scripted `3D_FullBody_Model` leg-chain contract by making `add_leg_chain.m` generate `Left Leg Kinetically Driven`, `Right Leg Kinetically Driven`, and `Ground Contact Forces` subsystems, adding configurable ground-contact workspace variables and polynomial coefficient defaults for both sides, and extending validation/docs/tests with a generated contact-block presence contract. |

...
| **Last Spec Update**    | 2026-05-08 (issue #4387 - Simscape input-MAT editor discovery, validation, transform overlay, and copy save) |
...
| Simscape Start-State Inputs | MAT       | Simscape MATLAB input files     | `3DModelInputs*.mat` scalar `*StartPosition*` / `*StartVelocity*` fields are edited only through the Simscape starting-pose provider. Required legacy `3D_Golf_Model` fields are validated explicitly, future full-body fields such as `LHipStartPositionX`, `LKneeStartPosition`, and `LAnkleStartPositionX` are discovered when present, matcher transforms apply as a non-mutating overlay, and default saves write a copied `<source>_starting_pose_<timestamp>.mat` file. |
...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-08 | 1.0.145 | Added the starting-pose matcher's Simscape input-MAT editor contract: provider-scoped SciPy MAT loading, scalar start-field discovery with metre/degree units, explicit legacy required-field validation, optional future full-body field discovery, transform-overlay save behavior, default copy-on-save naming, and session persistence of MAT paths only. |

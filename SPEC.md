...
- **Optimize bounding sphere radius computation**: Optimized bounding sphere radius computation in mesh primitive fitting using `np.einsum` to prevent temporary array allocations.

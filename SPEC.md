...
| 2026-05-18 | 1.0.87  | Bolt: Optimized `np.linalg.norm` to explicit element-wise computation using `np.einsum` in `_cg_primitive_fitting.py` and `collision_generator.py` for bounding sphere calculation. |

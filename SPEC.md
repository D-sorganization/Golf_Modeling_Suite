...
- **2026-08-22** - Made the modular Docker build boundary independently
  ...
  `setuptools` 78.1.1 after their final dependency layer, while both runtime
  Dockerfiles retain pip 26.2.1. This closes GHSA-6v7p-g79w-8964 and
  CVE-2025-47273 in the resolved container rather than suppressing Trivy.

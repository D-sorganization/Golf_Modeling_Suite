...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-12 | 1.0.357 | Consolidated the UI dependency refresh for React, React DOM, React types, postcss, Vitest coverage, Vitest, and typescript-eslint into one update branch, restored package-level motion-matching callable exports that collide with same-named modules, and lazy-loaded per-step surrogate train/optimize exports so `extract_dynamics_dataset` remains importable in optional-stack lanes without requiring torch-backed training dependencies. |

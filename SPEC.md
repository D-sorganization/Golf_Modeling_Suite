...
governed documentation and screenshot inventories are incomplete. Issue #9190
adds the provider-owned governed workflow authority: a committed, hashed
registry holds ten successful headless workflows, four deterministic failure
fixtures, and one explicitly unavailable non-executable optional-engine
workflow. The public executor uses argument arrays with `shell=False`, an
allowlisted environment, repository-relative working directories and
artifacts, exact source-commit checks, declared-output enforcement, and
type-aware artifact verification. Every code PR and protected-main push
executes the complete available registry and uploads exact-commit evidence for
review. That evidence demonstrates the declared software paths only; it is
neither a release nor scientific, engine, GUI, or human-use qualification. PR
#9180 remains the foundation: #9191 owns the complete screenshot/capture
contract; #9192 owns protected artifacts,
...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-30 | 1.0.679 | Implemented #9190's provider-owned governed workflow authority for the AffineDrift companion. A strict committed registry now declares ten successful headless workflows, four deterministic non-zero failure fixtures, and one optional OpenSim GUI path that is explicitly unavailable and non-executable. Every record carries exact source commit, prerequisites, allowlisted environment, repository-relative working directory and artifacts, verification method, fixture/tolerance declaration, documentation/program references, support state, and evidence-bounded limitations. The sole public executor uses argv arrays with `shell=False`, rejects shell metacharacters, absolute/traversing paths, undeclared environment and outputs, dangling references, unsupported executors, mutable references, stale source commits, missing/wrong-type artifacts, and wrong exit codes. CI executes every available record on code pull requests and protected `main`, publishes only commit-named 30-day review evidence, and feeds the required aggregate gate. This closes the implementable #9190 provider slice but grants no release, engine/GUI, screenshot, scientific, human, or operational qualification; #9174 remains open behind #9191/#9193 and protected review/publication evidence. |

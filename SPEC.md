...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-17 | 1.0.130 | CI portability: the local formatter guard pre-commit hook now invokes its helper through `python` instead of a POSIX `bash -c` wrapper, so the hook can run on Windows and Unix developer environments without shell-specific path handling. Regression coverage locks the cross-platform hook entry.                                                                                                                                                                                                                                                                                                                       |
...
| 2026-04-18 | 1.0.131 | Performance optimization: Replaced `np.linalg.norm` in list comprehensions with batched `np.einsum` calculations in `putting_green.py`, `grip_contact_model.py`, and `examples_motion_capture.py`. Added explicit safe-default empty-list guards to preserve numeric equivalence and avoid overhead on small multi-dimensional arrays.                                                                                                                                                                                          |

...
| **Last Spec Update**    | 2026-05-08 (OpenPose missing-keypoint diagnostics now exclude derivable synthetic joints while preserving observed-keypoint missing reporting) |
...
| 2026-05-08 | 1.0.144 | OpenPose missing-keypoint diagnostics now omit derived matcher joints (`mp`, `torso`, `hub`) when their source observations are sufficient to derive them, while still reporting truly missing or low-confidence observed keypoints such as elbows and clubhead. |
````

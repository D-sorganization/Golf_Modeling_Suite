...
- **Log Sanitization**: Logs must be sanitized to redact sensitive secrets (e.g. passwords, API keys) properly without causing valid JSON to break or leaking suffixes containing commas/braces.

...
- 2026-04-19: Bolt: Optimized SupportPolygon.distance_to_edge by replacing np.sum and np.linalg.norm with explicit scalar arithmetic and math.hypot for ~15x speedup.

...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-01 | 1.0.681 | Optimize Euclidean norm calculation (`np.linalg.norm` to `np.sqrt(np.einsum)`) in `src/shared/python/sidekick/calculators/electrical/electrical_model.py` for ~30% faster 2D distance execution. (spec-exempt: micro-optimization) |

...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-19 | 1.0.460 | Deduplicated the `set_speed` WebSocket handler for issue #7719. Extracted the identical clamp/config-update/stats-mirror block from `_handle_client_commands()` and `_wait_for_resume_or_stop()` in `src/api/routes/simulation_ws.py` into a single module-level `_apply_set_speed(websocket, config, msg)` helper, preserving exact behavior. Added focused `TestApplySetSpeed` unit coverage for clamping, config writes, stats mirroring, and the no-op stats path when the service chain is absent. |

...
| 2026-05-18 | 1.0.12  | Performance optimization in bounding sphere computation: explicitly computing squared distance using `np.einsum` to avoid `np.linalg.norm` overhead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |

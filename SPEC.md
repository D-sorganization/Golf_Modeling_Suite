...
| ---------- | ------- | ---------------------------------------------------------------------------------- | --------- |
| 2026-09-02 | 1.0.685 | Bumped `vendor/ud-tools` to Tools e88a334, carrying the whole ADR-0045/0047 Tools-side wave in one pin: the `swing_sim.ball_flight_trajectory/1` interchange record (H1, Tools#4888), the Impact Explorer flight playback replaying imported records with explicit frame conversion (H4, Tools#4890 - closes #9353), the UD-authored-green import in both runtimes (F2, Tools#4891 - closes #9344), and the playback-speeds drift gate (Tools#4887). The bump ARMS the four cross-family sanity gates in `test_flight_trajectory_export.py` with no test edit. Verified on this pin: launcher-manifest smoke 25 passed, ADR-0046 G0 drift gates 28 passed, flight-export suite 25 passed (zero skips). |

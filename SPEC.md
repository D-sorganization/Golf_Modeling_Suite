...
| 2026-05-18 | 1.0.87  | Bolt: Optimize bounding sphere radius computation in mesh primitive fitting using `np.einsum` to avoid intermediate temporary array allocations |

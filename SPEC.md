...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-20 | 1.0.140 | Issue #2810 — Rebuilt slim Docker runtime as focused PR. Kept runtime budget at 4,000 MB and explicitly documented Docker security scanning behavior against the runtime stage. Avoided installing PyQt and GUI dependencies (like X11 libs) in the runtime stage to keep the image significantly smaller, and enforced CPU-only PyTorch fetching. |
...
| 2026-04-20 | 1.0.138 | Bolt: Optimized `rotation_matrix_from_vectors` in `golf_data_core.py` by replacing `np.linalg.norm` and `np.allclose` with explicitly scalar `math.sqrt` and mathematical equivalents for low dimensional vectors to reduce Numpy abstraction overhead inside Numba. |

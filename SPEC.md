...
| ---------- | ------- | ---------------------------------------------------------------------------------- | --------- |
| 2026-09-01 | 1.0.681 | (spec-exempt: micro-optimization) Replaced `np.sum` with explicit list conversion and `np.asarray().sum()` in mpm ballreach. |
| 2026-09-01 | 1.0.680 | (spec-exempt: micro-optimization) Replaced `np.sum` with explicit list conversion and `np.asarray().sum()` in mpm ballreach. |
| 2026-09-01 | 1.0.679 | (spec-exempt: micro-optimization) Replaced `np.sum` with explicit list conversion and `np.asarray().sum()` in mpm ballreach. |

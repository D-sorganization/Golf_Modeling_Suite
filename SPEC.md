...
| 2026-07-20 | 1.0.443 | Bolt small-vector norm optimization for 3D Camera Controls. `golf_video_export.py` now uses `math.hypot` instead of `np.linalg.norm` for small fixed 3D vectors. |

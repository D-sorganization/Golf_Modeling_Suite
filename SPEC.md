...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-10 | 1.0.75  | Optimization: Replaced reduction-heavy `np.linalg.norm(..., axis=1)` calculation with explicit element-wise mathematical operations `np.sqrt(np.sum(np.square(diff, dtype=float), axis=1))` in electrical distance computations to improve performance.                                                                                                         |

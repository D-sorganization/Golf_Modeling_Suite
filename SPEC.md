...
| 2026-05-31 | 1.0.220 | Added the CC-25 engine-agnostic wrench/GRF extraction bridge (#6798), reusing `WrenchTrace` for canonical `Trace.wrench` conversion, impulse helpers, trace attachment, documentation, and static body-weight support validation. |

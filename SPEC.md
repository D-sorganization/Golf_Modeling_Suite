...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-17 | 1.0.126 | Repo hygiene: removed duplicate MIT LICENSE files from `src/engines/` subdirectories (drake, mujoco, pinocchio, pendulum_models, Simscape 2D/3D); root LICENSE is the canonical copy. Removed committed binary artifacts (bandit_results.json, coverage.json, test.npz, matlab_quality_report.txt, temp_id.txt) and added patterns to .gitignore. Moved 31 Jules-\* automation workflows to `.github/workflows/archived/` to prevent conflicting CI commits. Fixed .pre-commit-config.yaml to use `language_version: python3` for ruff hooks. Removed obsolete Black formatter references from Makefile and CONTRIBUTING.md.          |

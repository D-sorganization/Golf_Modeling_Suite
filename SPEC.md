...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-28 | 1.0.481 | Aligned launcher tile catalog API visibility with the manifest contract so `/launcher/tiles` excludes hidden aliases by default and `/launcher/tiles/{tile_id}` returns 404 for hidden entries (#8190). |
| 2026-07-28 | 1.0.481 | Corrected symbolic solver unavailable responses so solve, derivative, and simplify calls report `available=false` whenever SymPy is disabled instead of inheriting the import-time response-model default (#8197). |

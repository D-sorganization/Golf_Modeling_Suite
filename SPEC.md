...
- Optimized bounding sphere radius computation by utilizing `np.einsum` to calculate maximum squared distances instead of allocating arrays for individual distances.

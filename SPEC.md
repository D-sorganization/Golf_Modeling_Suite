...
- **2026-05-31** - Hardened the core-only install isolation guard so executing `scripts/check_core_install_isolation.py` cannot make helper directories such as `scripts/jaxsim` appear to be installed optional engines.
...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-31 | 1.0.217 | Added canonical-v2 dynamic state support for CC-2 (#6774): `CanonicalState` enforces the `(q, v, a, t)` floating-base layout with read-only arrays, unit quaternion and `nq = nv + 1` preconditions, manifold `integrate`/`difference` operations, canonical-v1 pose lifting, zero-state construction, and SE(3) quaternion helpers with regression coverage. |
| 2026-05-31 | 1.0.218 | Hardened the core-only install isolation guard to remove its own `scripts/` directory from `sys.path` before checking optional-engine imports, preventing helper folders such as `scripts/jaxsim` from masquerading as installed optional engines in CI. |

...
| 2026-04-12 | 1.0.89  | Performance(NumPy): replaced inefficient `np.sum(diff**2, axis=-1)` array reductions with high-performance `np.einsum('...i,...i->...', diff, diff)` across physics and RL modules, eliminating intermediate array allocations and improving calculation latency while maintaining dimension-agnostic correctness.                                                                                                                                                                                                                                                                                     |

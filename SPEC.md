...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-06-19 | 1.0.457 | Replaced re-declared gravity literals with the canonical `GRAVITY_FLOAT` for issue #7737. `src/engines/physics_engines/jaxsim/parameter_gradients.py` now imports `GRAVITY_FLOAT as _GRAVITY_M_S2` (identical 9.80665 value, ZTCF drift field unchanged), and `src/robotics/sensing/imu_sensor.py` derives `DEFAULT_IMU_GRAVITY_M_S2` from `GRAVITY_FLOAT` (a deliberate ~0.05 m/s² correction from 9.81 toward cross-engine parity, same rationale as #6638), keeping the module-level alias for backward-compatible imports. Focused tests assert both constants now equal `GRAVITY_FLOAT`, and the existing IMU sensor-frame gravity test was updated to the canonical magnitude. |

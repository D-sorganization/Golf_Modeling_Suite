...
````
| 2026-05-24 | 1.0.171 | Optimized constraint residual penalty computation using `np.vdot` and `np.sum(arr * arr)` for `AutoDiffXd` objects to prevent intermediate memory allocations. |

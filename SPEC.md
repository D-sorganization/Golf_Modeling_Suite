...
- Replaced `np.sum` with `ndarray.sum()` in sidekick PSA calculations to bypass NumPy dispatch overhead and improve summation performance. (spec-exempt: micro-optimization)

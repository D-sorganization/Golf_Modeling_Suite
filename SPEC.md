...
| 2026-05-03 | 1.0.88  | Bolt: Replaced `np.linalg.norm` with `math.hypot` in `src/deployment/safety/collision.py` to optimize 3D vector distance and gradient calculations |

...
| **Last Spec Update**    | 2026-05-08 (fix/starting-pose-matcher-legacy-import-4380 - legacy Simscape shim plus relocated GUI module-size baseline) |
...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-08 | 1.0.145 | Added the relocated `src/tools/starting_pose_matcher/gui.py` to the module-size budget baseline while the GUI decomposition remains tracked, keeping the legacy Simscape launcher compatibility PR aligned with the relocated matcher surface. |
| 2026-05-08 | 1.0.144 | Restored the legacy Simscape `Motion Capture Plotter/starting_pose_matcher.py` launcher as a compatibility shim that adds the repository root and `src/` to `sys.path`, imports the relocated `tools.starting_pose_matcher.gui` entry point, and keeps `python starting_pose_matcher.py` working for existing MATLAB GUI workflows. |

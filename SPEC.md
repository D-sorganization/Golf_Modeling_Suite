...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-19 | 1.0.134 | CI stabilization: standard pull-request CI now runs for markdown-only and docs-only pull requests by no longer excluding `docs/**` and `**.md` changes from the `pull_request` trigger while preserving the existing push-side documentation skip behavior.                                                                                                                                                                                                                                                                                                                            |

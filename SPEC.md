...
- Replaced `np.linalg.norm` with `math.hypot` in pendulum simulator segment geometry to bypass numpy dispatch overhead, yielding a ~7x speedup. (spec-exempt: micro-optimization)

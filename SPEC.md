...
- **Documentation Governance Contracts**: Validate the canonical `docs/index.md` directory catalog, rendered documentation hub link, Markdown/Quarto size budget, and significant-word title capitalization for changed Markdown, Quarto, LaTeX, Word, and PDF documents. UP-D0 (#9066) additionally establishes `manuals/upstreamdrift` QMD as the sole engineering design-manual authority and keeps generated artifacts and public projection blocked through an executable governance contract.

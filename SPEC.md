...
| 2026-04-17 | 1.0.127 | Performance: Replaced np.sum((positions - center) ** 2, axis=1) with np.einsum in golf_visualizer_widget.py to optimize distance calculations. |

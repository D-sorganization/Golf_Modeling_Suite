...
| 2026-05-02 | 1.0.3   | Performance optimization: explicitly computing maximum vector magnitude via `np.sqrt(np.max(np.einsum(...)))` to avoid `np.linalg.norm` overhead in bounding sphere radius computation for a ~4.6x speedup.                                                                                                                                                                                                                                                                                                                                                                                                                                                               |

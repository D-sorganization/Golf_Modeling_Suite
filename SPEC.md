...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-09-02 | 1.0.693 | Optimized Spectral Arc Length (SAL) computation by replacing `np.sum(np.sqrt(...))` with `np.hypot(...).sum()`, providing a ~2.3x performance speedup without changing behavior. |

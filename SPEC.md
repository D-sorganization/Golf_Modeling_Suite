...
| 2026-05-02 | 1.0.94  | Performance optimization in collision checking: explicitly computing 3D vector norms via `math.hypot` to avoid `np.linalg.norm` and array allocation overhead.                                                                                                                                                                                                                                                                                                                                                                                                                                    |

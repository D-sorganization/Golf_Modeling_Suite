...
| 2026-04-02 | 1.0.12  | Bolt: Optimized `np.linalg.norm(..., axis=1)` to explicit squared distances in `trajectory_funnel_benchmark.py` to avoid expensive reduction and sqrt overhead.                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 2026-04-29 | 1.0.12  | Bolt: Replaced np.linalg.norm with math.hypot in collision shapes for 3D vector distance optimization |
| 2026-04-29 | 1.0.12  | Bolt: Replaced np.linalg.norm with math.hypot in collision shapes for 3D vector distance optimization. |
| 2026-04-29 | 1.0.12  | Bolt: Replaced np.linalg.norm with math.hypot in collision shapes for 3D vector distance optimization |
...
| 2026-05-01 | 1.0.12  | Added artifact generator for portfolio demo output. |

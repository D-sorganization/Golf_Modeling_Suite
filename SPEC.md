...
| 2026-05-02 | 1.0.4   | Performance optimization in collision checking: replaced `np.linalg.norm` with `math.hypot` for 3D vector magnitude calculation in high-frequency distance computations to reduce overhead and improve collision detection speed.                                                                                                                                                                                                                                                                                                                                                         |

...
- **2026-08-11** - Published the independently reviewed launcher-settings
  ...
  head `624043537a5ab10aa7ef56dc61685a004b872c0c`. The independent review found no
  actionable compatibility, MRO, behavior-parity, or Qt worker-lifecycle
  regression and reran all 44 focused tests successfully. Protected CI,
  approval, parent dependency, issue completion, and release state remain open.

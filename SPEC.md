...
| ------------------------------ | -------------------------------------- | --------------------------------------------------------------- | ------------------ |
| `ci-standard.yml`              | Push/PR                                | Lint, type check, root hygiene guard, unit/integration tests     | Yes                |
...
| 2026-05-02 | 1.0.94  | Added explicit repo-root hygiene enforcement through `scripts/check_root_clutter.py`, CI wiring, and forbidden generated-artifact patterns for backup files, PR body drafts, root one-shot fix scripts, and CI trigger files.                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| 2026-05-03 | 1.0.95 | Updated root-hygiene CI to ignore deleted Python paths in changed-file Ruff checks and to protect the relocated `installer/legacy_setup.py` entrypoint. |

...
| 2026-04-28 | 1.0.4   | Performance optimization: Replaced `np.sum(diff**2, axis=0)` with `np.einsum` in ball simulator batch force calculations to skip temporary array allocation overhead.                                                                                                                                                                                                                                                                                                                         |

...
| **Last Spec Update**    | 2026-05-07 (Cross-option leaderboard metrics JSON strictness) |
...
| 2026-05-07 | 1.0.128 | Hardened cross-option leaderboard metrics JSON to serialize no-success RMSE sentinels as `null` under strict JSON and removed a temporary root merge helper blocked by the root-clutter gate. |
````

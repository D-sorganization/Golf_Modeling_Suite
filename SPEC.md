...
| 2026-05-31 | 1.0.221 | Added CC-20 multi-trial / multi-view MAP stacking with shared-parameter locking, serialization, and posterior-tightening checks (#6793). |
````

...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-27 | 1.0.610 | Advanced #8358 through the immutable Tools R14.3 consumer boundary. The `vendor/ud-tools` gitlink now pins protected Tools squash `3dfbd32cc778536269670c055955073853c0f60a`; a downstream provider contract verifies the UI-neutral `all_together`/`individual`/`both` execution-policy set, exact joint and one-at-a-time run accounting, and the protected PyQt variation baseline (`22f6640e896e9ea5c740e9db7e3d3201cdf7264f2cf1cff33966b539354f1d40`) with its narrow reviewed tolerance. UpstreamDrift continues to launch the Tools-owned surface instead of copying UI or analysis code. This qualifies an immutable software-consumer boundary, not participant evidence, human strategy, or coaching guidance. |

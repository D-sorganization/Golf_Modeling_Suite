...
| 2026-05-31 | 1.0.220 | Added the CC-12 canonical observations schema for markerless pose ingestion (#6785), including detector layout, calibrated camera metadata, per-camera 2D keypoints/confidence, optional 3D keypoints, JSON round-tripping, trace metadata attachment, fixtures, docs, and tests. |

...
- **2026-05-27** - Tightened sensitive logging redaction so unquoted secret values stop at common delimiters such as commas instead of consuming adjacent list content; added regression coverage in `tests/unit/test_logging_config.py`.
...
| ---------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-27 | 1.0.195 | Tightened sensitive logging redaction so unquoted secret values stop at common delimiters such as commas instead of consuming adjacent list content; added regression coverage in `tests/unit/test_logging_config.py`. |

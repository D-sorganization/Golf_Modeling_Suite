...
| ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-04-07 | 1.0.36  | Replaced the remaining raw `print()` calls in the Windows installer build path with an explicit stdout helper so command-line installer feedback remains stable under the repository logging policy, and added regression coverage for prerequisite and generated-artifact messaging in the installer test suite.                                                                                                                                                                                                                                                                                                                  |

...
| cross-engine-leaderboard.yml       | pull_request/workflow_dispatch               | @physics  | contents: read / pull-requests: write  | KEEP: report-only cross-engine leaderboard refresh for committed parity fit outputs.    | n/a                                |
...
| humanoid-models-drift.yml          | pull_request                                 | @physics  | contents: read / pull-requests: write  | KEEP: advisory shared humanoid YAML-to-engine-model drift check.                        | n/a                                |

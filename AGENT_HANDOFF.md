...
- #8684 governs distributed grip, shaft, and ground:
  ...
  - #8800 is **OPEN** and blocks #8752. Its governed generator regenerates all
    ...
    Common-support analysis reproduces nominal 126/384 shaft and 0/384 ground while preserving identities, denominators, failures, resolution, and unpooled secants. Atomic digest-bound NPZ cell packs use no pickle and the plan-bound result requires seven corners plus six axis/pathway summaries; both reject partial/tampered evidence. Results remain model-dependent, not causal, population, mechanism, ranking, or coaching claims.

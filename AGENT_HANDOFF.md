...
- Runs 33174130362/33177181557/33182809219 completed 0:6/22:46/46:70; cancelled 33174462839/33187478053 retained 6:22/70:94; later success runs completed through 674, including run 33268388252 for 654:674.
- Collector `30e38344f` rejects drift, overlap, corruption, or a gap from zero;
  authority is 674/2,304, manifest SHA-256 `bc784b1fdedb0aa2571da6841017f4f6e84bf4602c96cbb073617ed4237dca40`.
- Run 33271631525 executes 674:694 from head `b9ef29a07dd5` with one process and a 90-minute timeout; the next unassigned case is 694.
...
1. Do not restart/combine the Windows diagnostic. Validate run 33271631525, then continue 20-case hosted slices from 694 against audit 33173678044; completed JSON requires its NPZ.
...
- #8800 remains frozen at `1bd4d57da7bd257b76b42b3cc19524b283b5f748`;
  ...
  at 48/48. The WSL VHDX is unreadable (`0x80070570`).
- Do not start WSL, repair/mount/copy/mutate the VHDX, restart services, or
  launch a replacement without explicit approval and a recoverability plan.

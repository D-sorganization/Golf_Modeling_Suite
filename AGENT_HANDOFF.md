...
- Protected repair PR #9094 regenerated manufactured-solution evidence through
  the governed path. The release bundle validates with 617 artifacts after
  #9100. This remains computational model evidence, not human validation or
  design-manual approval.

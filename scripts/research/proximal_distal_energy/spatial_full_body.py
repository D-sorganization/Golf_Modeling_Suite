...
def _default_spatial_joints() -> tuple[JointSpec, ...]:
    return (
        JointSpec(
...
def _default_physical_bodies() -> tuple[BodySpec, ...]:
    return (
...
def build_spatial_model() -> SpatialModel:
    ...
    joints = _default_spatial_joints()
    physical_bodies = _default_physical_bodies()

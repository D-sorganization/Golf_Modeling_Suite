"""Write the articulated bilateral contact-projection evidence."""
...
def main() -> int:
    ...
    record, arrays = run_articulated_contact_projection_atlas()
    json_path = DATA_DIR / "articulated_contact_projection.json"
    npz_path = DATA_DIR / "articulated_contact_projection.npz"

"""Write bounded articulated forward-contact evidence."""
...
def main() -> int:
    ...
    record, arrays = run_articulated_forward_contact_atlas()
    json_path = DATA_DIR / "articulated_forward_contact.json"
    npz_path = DATA_DIR / "articulated_forward_contact.npz"
